...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   ...
   f:	c7 44 24 04 3a 08 00 	movl   $0x83a,0x4(%esp)
  16:	00 
  17:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  1e:	e8 4b 04 00 00       	call   46e <printf>
    exit();
  23:	e8 be 02 00 00       	call   2e6 <exit>
  }
  ...
  3f:	e8 02 03 00 00       	call   346 <link>
  ...
  60:	c7 44 24 04 4d 08 00 	movl   $0x84d,0x4(%esp)
  67:	00 
  68:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  6f:	e8 fa 03 00 00       	call   46e <printf>
  exit();
  74:	e8 6d 02 00 00       	call   2e6 <exit>
...
memset(void *dst, int c, uint n)
{
 ...
 153:	e8 21 ff ff ff       	call   79 <stosb>
  return dst;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 407:	0f b6 80 cc 0a 00 00 	movzbl 0xacc(%eax),%eax
...
free(void *ap)
{
 ...
 630:	a1 e8 0a 00 00       	mov    0xae8,%eax
 ...
 6fb:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 700:	c9                   	leave  
 701:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7f3:	a3 e8 0a 00 00       	mov    %eax,0xae8
      return (void*)(p + 1);
 ...
 7fe:	eb 38                	jmp    838 <malloc+0xde>
    ...
    if(p == freep)
 800:	a1 e8 0a 00 00       	mov    0xae8,%eax
