...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 c4 64 00 00       	mov    0x64c4,%eax
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 c4 64 00 00       	mov    0x64c4,%eax
  ...
  pid = fork();
      f5:	e8 ed 3e 00 00       	call   3fe7 <fork>
      fa:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pid < 0){
      fd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     101:	79 1a                	jns    11d <exitiputtest+0x43>
    printf(stdout, "fork failed\n");
     103:	a1 c4 64 00 00       	mov    0x64c4,%eax
     108:	c7 44 24 04 e5 45 00 	movl   $0x45e5,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 5f 40 00 00       	call   4177 <printf>
    exit();
     118:	e8 d2 3e 00 00       	call   3fef <exit>
  }
  if(pid == 0){
     11d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     121:	0f 85 83 00 00 00    	jne    1aa <exitiputtest+0xd0>
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 65 45 00 00 	movl   $0x4565,(%esp)
     12e:	e8 24 3f 00 00       	call   4057 <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 c4 64 00 00       	mov    0x64c4,%eax
     13c:	c7 44 24 04 6d 45 00 	movl   $0x456d,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 2b 40 00 00       	call   4177 <printf>
      exit();
     14c:	e8 9e 3e 00 00       	call   3fef <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 65 45 00 00 	movl   $0x4565,(%esp)
     158:	e8 02 3f 00 00       	call   405f <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 c4 64 00 00       	mov    0x64c4,%eax
     166:	c7 44 24 04 f2 45 00 	movl   $0x45f2,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 01 40 00 00       	call   4177 <printf>
      exit();
     176:	e8 74 3e 00 00       	call   3fef <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 91 45 00 00 	movl   $0x4591,(%esp)
     182:	e8 b8 3e 00 00       	call   403f <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 c4 64 00 00       	mov    0x64c4,%eax
     190:	c7 44 24 04 9c 45 00 	movl   $0x459c,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 d7 3f 00 00       	call   4177 <printf>
      exit();
     1a0:	e8 4a 3e 00 00       	call   3fef <exit>
    }
    exit();
     1a5:	e8 45 3e 00 00       	call   3fef <exit>
  }
  wait();
     1aa:	e8 48 3e 00 00       	call   3ff7 <wait>
  printf(stdout, "exitiput test ok\n");
     1af:	a1 c4 64 00 00       	mov    0x64c4,%eax
     1b4:	c7 44 24 04 06 46 00 	movl   $0x4606,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 b3 3f 00 00       	call   4177 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 c4 64 00 00       	mov    0x64c4,%eax
     1d1:	c7 44 24 04 18 46 00 	movl   $0x4618,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 96 3f 00 00       	call   4177 <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 27 46 00 00 	movl   $0x4627,(%esp)
     1e8:	e8 6a 3e 00 00       	call   4057 <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 c4 64 00 00       	mov    0x64c4,%eax
     1f6:	c7 44 24 04 2d 46 00 	movl   $0x462d,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 71 3f 00 00       	call   4177 <printf>
    exit();
     206:	e8 e4 3d 00 00       	call   3fef <exit>
  }
  pid = fork();
     20b:	e8 d7 3d 00 00       	call   3fe7 <fork>
     210:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pid < 0){
     213:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     217:	79 1a                	jns    233 <openiputtest+0x6d>
    printf(stdout, "fork failed\n");
     219:	a1 c4 64 00 00       	mov    0x64c4,%eax
     21e:	c7 44 24 04 e5 45 00 	movl   $0x45e5,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 49 3f 00 00       	call   4177 <printf>
    exit();
     22e:	e8 bc 3d 00 00       	call   3fef <exit>
  }
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 27 46 00 00 	movl   $0x4627,(%esp)
     248:	e8 e2 3d 00 00       	call   402f <open>
     24d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(fd >= 0){
     250:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     254:	78 1a                	js     270 <openiputtest+0xaa>
      printf(stdout, "open directory for write succeeded\n");
     256:	a1 c4 64 00 00       	mov    0x64c4,%eax
     25b:	c7 44 24 04 44 46 00 	movl   $0x4644,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 0c 3f 00 00       	call   4177 <printf>
      exit();
     26b:	e8 7f 3d 00 00       	call   3fef <exit>
    }
    exit();
     270:	e8 7a 3d 00 00       	call   3fef <exit>
  }
  sleep(1);
     275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     27c:	e8 fe 3d 00 00       	call   407f <sleep>
  if(unlink("oidir") != 0){
     281:	c7 04 24 27 46 00 00 	movl   $0x4627,(%esp)
     288:	e8 b2 3d 00 00       	call   403f <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 c4 64 00 00       	mov    0x64c4,%eax
     296:	c7 44 24 04 68 46 00 	movl   $0x4668,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 d1 3e 00 00       	call   4177 <printf>
    exit();
     2a6:	e8 44 3d 00 00       	call   3fef <exit>
  }
  wait();
     2ab:	e8 47 3d 00 00       	call   3ff7 <wait>
  printf(stdout, "openiput test ok\n");
     2b0:	a1 c4 64 00 00       	mov    0x64c4,%eax
     2b5:	c7 44 24 04 77 46 00 	movl   $0x4677,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 b2 3e 00 00       	call   4177 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 c4 64 00 00       	mov    0x64c4,%eax
     2d2:	c7 44 24 04 89 46 00 	movl   $0x4689,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 95 3e 00 00       	call   4177 <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 44 45 00 00 	movl   $0x4544,(%esp)
     2f1:	e8 39 3d 00 00       	call   402f <open>
     2f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
     2f9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     2fd:	79 1a                	jns    319 <opentest+0x52>
    printf(stdout, "open echo failed!\n");
     2ff:	a1 c4 64 00 00       	mov    0x64c4,%eax
     304:	c7 44 24 04 94 46 00 	movl   $0x4694,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 63 3e 00 00       	call   4177 <printf>
    exit();
     314:	e8 d6 3c 00 00       	call   3fef <exit>
  }
  close(fd);
     319:	8b 45 f4             	mov    -0xc(%ebp),%eax
     31c:	89 04 24             	mov    %eax,(%esp)
     31f:	e8 f3 3c 00 00       	call   4017 <close>
  fd = open("doesnotexist", 0);
     324:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     32b:	00 
     32c:	c7 04 24 a7 46 00 00 	movl   $0x46a7,(%esp)
     333:	e8 f7 3c 00 00       	call   402f <open>
     338:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
     33b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     33f:	78 1a                	js     35b <opentest+0x94>
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 c4 64 00 00       	mov    0x64c4,%eax
     346:	c7 44 24 04 b4 46 00 	movl   $0x46b4,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 21 3e 00 00       	call   4177 <printf>
    exit();
     356:	e8 94 3c 00 00       	call   3fef <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 c4 64 00 00       	mov    0x64c4,%eax
     360:	c7 44 24 04 d2 46 00 	movl   $0x46d2,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 07 3e 00 00       	call   4177 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 c4 64 00 00       	mov    0x64c4,%eax
     37d:	c7 44 24 04 e0 46 00 	movl   $0x46e0,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 ea 3d 00 00       	call   4177 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 f1 46 00 00 	movl   $0x46f1,(%esp)
     39c:	e8 8e 3c 00 00       	call   402f <open>
     3a1:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(fd >= 0){
     3a4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     3a8:	78 21                	js     3cb <writetest+0x59>
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 c4 64 00 00       	mov    0x64c4,%eax
     3af:	c7 44 24 04 f7 46 00 	movl   $0x46f7,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 b8 3d 00 00       	call   4177 <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 c4 64 00 00       	mov    0x64c4,%eax
     3d0:	c7 44 24 04 12 47 00 	movl   $0x4712,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 97 3d 00 00       	call   4177 <printf>
    exit();
     3e0:	e8 0a 3c 00 00       	call   3fef <exit>
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     3e5:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     3ec:	00 
     3ed:	c7 44 24 04 2e 47 00 	movl   $0x472e,0x4(%esp)
     3f4:	00 
     3f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
     3f8:	89 04 24             	mov    %eax,(%esp)
     3fb:	e8 0f 3c 00 00       	call   400f <write>
     400:	83 f8 0a             	cmp    $0xa,%eax
     403:	74 21                	je     426 <writetest+0xb4>
      printf(stdout, "error: write aa %d new file failed\n", i);
     405:	a1 c4 64 00 00       	mov    0x64c4,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 3c 47 00 	movl   $0x473c,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 56 3d 00 00       	call   4177 <printf>
      exit();
     421:	e8 c9 3b 00 00       	call   3fef <exit>
    }
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     426:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     42d:	00 
     42e:	c7 44 24 04 60 47 00 	movl   $0x4760,0x4(%esp)
     435:	00 
     436:	8b 45 f0             	mov    -0x10(%ebp),%eax
     439:	89 04 24             	mov    %eax,(%esp)
     43c:	e8 ce 3b 00 00       	call   400f <write>
     441:	83 f8 0a             	cmp    $0xa,%eax
     444:	74 21                	je     467 <writetest+0xf5>
      printf(stdout, "error: write bb %d new file failed\n", i);
     446:	a1 c4 64 00 00       	mov    0x64c4,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 6c 47 00 	movl   $0x476c,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 15 3d 00 00       	call   4177 <printf>
      exit();
     462:	e8 88 3b 00 00       	call   3fef <exit>
  for(i = 0; i < 100; i++){
  ...
  printf(stdout, "writes ok\n");
     475:	a1 c4 64 00 00       	mov    0x64c4,%eax
     47a:	c7 44 24 04 90 47 00 	movl   $0x4790,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 ed 3c 00 00       	call   4177 <printf>
  close(fd);
     48a:	8b 45 f0             	mov    -0x10(%ebp),%eax
     48d:	89 04 24             	mov    %eax,(%esp)
     490:	e8 82 3b 00 00       	call   4017 <close>
  fd = open("small", O_RDONLY);
     495:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     49c:	00 
     49d:	c7 04 24 f1 46 00 00 	movl   $0x46f1,(%esp)
     4a4:	e8 86 3b 00 00       	call   402f <open>
     4a9:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(fd >= 0){
     4ac:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     4b0:	78 3e                	js     4f0 <writetest+0x17e>
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 c4 64 00 00       	mov    0x64c4,%eax
     4b7:	c7 44 24 04 9b 47 00 	movl   $0x479b,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 b0 3c 00 00       	call   4177 <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     4dd:	e8 25 3b 00 00       	call   4007 <read>
  ...
  if(i == 2000){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 c4 64 00 00       	mov    0x64c4,%eax
     4f5:	c7 44 24 04 b4 47 00 	movl   $0x47b4,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 72 3c 00 00       	call   4177 <printf>
    exit();
     505:	e8 e5 3a 00 00       	call   3fef <exit>
    printf(stdout, "read succeeded ok\n");
     50a:	a1 c4 64 00 00       	mov    0x64c4,%eax
     50f:	c7 44 24 04 cf 47 00 	movl   $0x47cf,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 58 3c 00 00       	call   4177 <printf>
  } else {
  ...
  close(fd);
     ...
     525:	e8 ed 3a 00 00       	call   4017 <close>

  if(unlink("small") < 0){
     52a:	c7 04 24 f1 46 00 00 	movl   $0x46f1,(%esp)
     531:	e8 09 3b 00 00       	call   403f <unlink>
     536:	85 c0                	test   %eax,%eax
     538:	79 36                	jns    570 <writetest+0x1fe>
     53a:	eb 1a                	jmp    556 <writetest+0x1e4>
    printf(stdout, "read failed\n");
     53c:	a1 c4 64 00 00       	mov    0x64c4,%eax
     541:	c7 44 24 04 e2 47 00 	movl   $0x47e2,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 26 3c 00 00       	call   4177 <printf>
    exit();
     551:	e8 99 3a 00 00       	call   3fef <exit>
    printf(stdout, "unlink small failed\n");
     556:	a1 c4 64 00 00       	mov    0x64c4,%eax
     55b:	c7 44 24 04 ef 47 00 	movl   $0x47ef,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 0c 3c 00 00       	call   4177 <printf>
    exit();
     56b:	e8 7f 3a 00 00       	call   3fef <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 c4 64 00 00       	mov    0x64c4,%eax
     575:	c7 44 24 04 04 48 00 	movl   $0x4804,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 f2 3b 00 00       	call   4177 <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 c4 64 00 00       	mov    0x64c4,%eax
     592:	c7 44 24 04 18 48 00 	movl   $0x4818,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 d5 3b 00 00       	call   4177 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 28 48 00 00 	movl   $0x4828,(%esp)
     5b1:	e8 79 3a 00 00       	call   402f <open>
     5b6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
     5b9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     5bd:	79 1a                	jns    5d9 <writetest1+0x52>
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 c4 64 00 00       	mov    0x64c4,%eax
     5c4:	c7 44 24 04 2c 48 00 	movl   $0x482c,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 a3 3b 00 00       	call   4177 <printf>
    exit();
     5d4:	e8 16 3a 00 00       	call   3fef <exit>
  }
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     602:	e8 08 3a 00 00       	call   400f <write>
     607:	3d 00 02 00 00       	cmp    $0x200,%eax
     60c:	74 21                	je     62f <writetest1+0xa8>
      printf(stdout, "error: write big file failed\n", i);
     60e:	a1 c4 64 00 00       	mov    0x64c4,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 46 48 00 	movl   $0x4846,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 4d 3b 00 00       	call   4177 <printf>
      exit();
     62a:	e8 c0 39 00 00       	call   3fef <exit>
  for(i = 0; i < MAXFILE; i++){
  ...
  close(fd);
     ...
     643:	e8 cf 39 00 00       	call   4017 <close>

  fd = open("big", O_RDONLY);
     648:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     64f:	00 
     650:	c7 04 24 28 48 00 00 	movl   $0x4828,(%esp)
     657:	e8 d3 39 00 00       	call   402f <open>
     65c:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
     65f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     663:	79 1a                	jns    67f <writetest1+0xf8>
    printf(stdout, "error: open big failed!\n");
     665:	a1 c4 64 00 00       	mov    0x64c4,%eax
     66a:	c7 44 24 04 64 48 00 	movl   $0x4864,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 fd 3a 00 00       	call   4177 <printf>
    exit();
     67a:	e8 70 39 00 00       	call   3fef <exit>
  }
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     69c:	e8 66 39 00 00       	call   4007 <read>
    ...
    if(i == 0){
     ...
     6b3:	a1 c4 64 00 00       	mov    0x64c4,%eax
     6b8:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bb:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bf:	c7 44 24 04 7d 48 00 	movl   $0x487d,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 a8 3a 00 00       	call   4177 <printf>
        exit();
     6cf:	e8 1b 39 00 00       	call   3fef <exit>
      }
      break;
     6d4:	90                   	nop
             n, ((int*)buf)[0]);
  ...
  close(fd);
     ...
     6db:	e8 37 39 00 00       	call   4017 <close>
  if(unlink("big") < 0){
     6e0:	c7 04 24 28 48 00 00 	movl   $0x4828,(%esp)
     6e7:	e8 53 39 00 00       	call   403f <unlink>
     ...
     6ff:	a1 c4 64 00 00       	mov    0x64c4,%eax
     704:	8b 55 f4             	mov    -0xc(%ebp),%edx
     707:	89 54 24 08          	mov    %edx,0x8(%esp)
     70b:	c7 44 24 04 9a 48 00 	movl   $0x489a,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 5c 3a 00 00       	call   4177 <printf>
      exit();
     71b:	e8 cf 38 00 00       	call   3fef <exit>
    if(((int*)buf)[0] != n){
     ...
     733:	a1 c4 64 00 00       	mov    0x64c4,%eax
     738:	89 54 24 0c          	mov    %edx,0xc(%esp)
     73c:	8b 55 f0             	mov    -0x10(%ebp),%edx
     73f:	89 54 24 08          	mov    %edx,0x8(%esp)
     743:	c7 44 24 04 ac 48 00 	movl   $0x48ac,0x4(%esp)
     74a:	00 
     74b:	89 04 24             	mov    %eax,(%esp)
     74e:	e8 24 3a 00 00       	call   4177 <printf>
      exit();
     753:	e8 97 38 00 00       	call   3fef <exit>
    n++;
     758:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  }
     75c:	e9 25 ff ff ff       	jmp    686 <writetest1+0xff>
    printf(stdout, "unlink big failed\n");
     761:	a1 c4 64 00 00       	mov    0x64c4,%eax
     766:	c7 44 24 04 cc 48 00 	movl   $0x48cc,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 01 3a 00 00       	call   4177 <printf>
    exit();
     776:	e8 74 38 00 00       	call   3fef <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 c4 64 00 00       	mov    0x64c4,%eax
     780:	c7 44 24 04 df 48 00 	movl   $0x48df,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 e7 39 00 00       	call   4177 <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     798:	a1 c4 64 00 00       	mov    0x64c4,%eax
     79d:	c7 44 24 04 f0 48 00 	movl   $0x48f0,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 ca 39 00 00       	call   4177 <printf>
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     824:	e8 16 38 00 00       	call   403f <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     833:	a1 c4 64 00 00       	mov    0x64c4,%eax
     838:	c7 44 24 04 18 49 00 	movl   $0x4918,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 2f 39 00 00       	call   4177 <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     850:	a1 c4 64 00 00       	mov    0x64c4,%eax
     855:	c7 44 24 04 3e 49 00 	movl   $0x493e,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 12 39 00 00       	call   4177 <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 4a 49 00 00 	movl   $0x494a,(%esp)
     86c:	e8 e6 37 00 00       	call   4057 <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 c4 64 00 00       	mov    0x64c4,%eax
     87a:	c7 44 24 04 6d 45 00 	movl   $0x456d,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 ed 38 00 00       	call   4177 <printf>
    exit();
     88a:	e8 60 37 00 00       	call   3fef <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 4a 49 00 00 	movl   $0x494a,(%esp)
     896:	e8 c4 37 00 00       	call   405f <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 c4 64 00 00       	mov    0x64c4,%eax
     8a4:	c7 44 24 04 4f 49 00 	movl   $0x494f,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 c3 38 00 00       	call   4177 <printf>
    exit();
     8b4:	e8 36 37 00 00       	call   3fef <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 62 49 00 00 	movl   $0x4962,(%esp)
     8c0:	e8 9a 37 00 00       	call   405f <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 c4 64 00 00       	mov    0x64c4,%eax
     8ce:	c7 44 24 04 65 49 00 	movl   $0x4965,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 99 38 00 00       	call   4177 <printf>
    exit();
     8de:	e8 0c 37 00 00       	call   3fef <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 4a 49 00 00 	movl   $0x494a,(%esp)
     8ea:	e8 50 37 00 00       	call   403f <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 c4 64 00 00       	mov    0x64c4,%eax
     8f8:	c7 44 24 04 76 49 00 	movl   $0x4976,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 6f 38 00 00       	call   4177 <printf>
    exit();
     908:	e8 e2 36 00 00       	call   3fef <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 c4 64 00 00       	mov    0x64c4,%eax
     912:	c7 44 24 04 8a 49 00 	movl   $0x498a,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 55 38 00 00       	call   4177 <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     92a:	a1 c4 64 00 00       	mov    0x64c4,%eax
     92f:	c7 44 24 04 99 49 00 	movl   $0x4999,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 38 38 00 00       	call   4177 <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 b0 64 00 	movl   $0x64b0,0x4(%esp)
     946:	00 
     947:	c7 04 24 44 45 00 00 	movl   $0x4544,(%esp)
     94e:	e8 d4 36 00 00       	call   4027 <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 c4 64 00 00       	mov    0x64c4,%eax
     95c:	c7 44 24 04 a4 49 00 	movl   $0x49a4,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 0b 38 00 00       	call   4177 <printf>
    exit();
     96c:	e8 7e 36 00 00       	call   3fef <exit>
  }
}
     971:	c9                   	leave  
     972:	c3                   	ret    
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     97f:	e8 7b 36 00 00       	call   3fff <pipe>
     984:	85 c0                	test   %eax,%eax
     986:	74 19                	je     9a1 <pipe1+0x2e>
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 b6 49 00 	movl   $0x49b6,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 db 37 00 00       	call   4177 <printf>
    exit();
     99c:	e8 4e 36 00 00       	call   3fef <exit>
  }
  pid = fork();
     9a1:	e8 41 36 00 00       	call   3fe7 <fork>
  ...
  if(pid == 0){
    ...
    close(fds[0]);
     ...
     9c0:	e8 52 36 00 00       	call   4017 <close>
    for(n = 0; n < 5; n++){
     ...
     a0e:	e8 fc 35 00 00       	call   400f <write>
     a13:	3d 09 04 00 00       	cmp    $0x409,%eax
     a18:	74 19                	je     a33 <pipe1+0xc0>
        printf(1, "pipe1 oops 1\n");
     a1a:	c7 44 24 04 c5 49 00 	movl   $0x49c5,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 49 37 00 00       	call   4177 <printf>
        exit();
     a2e:	e8 bc 35 00 00       	call   3fef <exit>
    for(n = 0; n < 5; n++){
    ...
    exit();
     a3d:	e8 ad 35 00 00       	call   3fef <exit>
  } else if(pid > 0){
    ...
    close(fds[1]);
     ...
     a52:	e8 c0 35 00 00       	call   4017 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a90:	c7 44 24 04 d3 49 00 	movl   $0x49d3,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 d3 36 00 00       	call   4177 <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ae4:	e8 1e 35 00 00       	call   4007 <read>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 e1 49 00 	movl   $0x49e1,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 5d 36 00 00       	call   4177 <printf>
      exit();
     b1a:	e8 d0 34 00 00       	call   3fef <exit>
    }
    close(fds[0]);
     b1f:	8b 45 d8             	mov    -0x28(%ebp),%eax
     b22:	89 04 24             	mov    %eax,(%esp)
     b25:	e8 ed 34 00 00       	call   4017 <close>
    wait();
     b2a:	e8 c8 34 00 00       	call   3ff7 <wait>
  } else {
    printf(1, "fork() failed\n");
    exit();
  }
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 07 4a 00 	movl   $0x4a07,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 34 36 00 00       	call   4177 <printf>
     b43:	eb 19                	jmp    b5e <pipe1+0x1eb>
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 f8 49 00 	movl   $0x49f8,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 1e 36 00 00       	call   4177 <printf>
    exit();
     b59:	e8 91 34 00 00       	call   3fef <exit>
}
     b5e:	c9                   	leave  
     b5f:	c3                   	ret    
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 11 4a 00 	movl   $0x4a11,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 fd 35 00 00       	call   4177 <printf>
  pid1 = fork();
     b7a:	e8 68 34 00 00       	call   3fe7 <fork>
  ...
  pid2 = fork();
     b8a:	e8 58 34 00 00       	call   3fe7 <fork>
  ...
  pipe(pfds);
     ...
     ba0:	e8 5a 34 00 00       	call   3fff <pipe>
  pid3 = fork();
     ba5:	e8 3d 34 00 00       	call   3fe7 <fork>
  ...
  close(pfds[1]);
     ...
     c05:	e8 0d 34 00 00       	call   4017 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c20:	e8 e2 33 00 00       	call   4007 <read>
     c25:	83 f8 01             	cmp    $0x1,%eax
     c28:	74 16                	je     c40 <preempt+0xe0>
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 31 4a 00 	movl   $0x4a31,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 39 35 00 00       	call   4177 <printf>
  ...
  close(pfds[0]);
     ...
     c46:	e8 cc 33 00 00       	call   4017 <close>
  printf(1, "kill... ");
     c4b:	c7 44 24 04 44 4a 00 	movl   $0x4a44,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 18 35 00 00       	call   4177 <printf>
  kill(pid1);
     c5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
     c62:	89 04 24             	mov    %eax,(%esp)
     c65:	e8 b5 33 00 00       	call   401f <kill>
  kill(pid2);
     c6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
     c6d:	89 04 24             	mov    %eax,(%esp)
     c70:	e8 aa 33 00 00       	call   401f <kill>
  kill(pid3);
     c75:	8b 45 ec             	mov    -0x14(%ebp),%eax
     c78:	89 04 24             	mov    %eax,(%esp)
     c7b:	e8 9f 33 00 00       	call   401f <kill>
  printf(1, "wait... ");
     c80:	c7 44 24 04 4d 4a 00 	movl   $0x4a4d,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 e3 34 00 00       	call   4177 <printf>
  wait();
     c94:	e8 5e 33 00 00       	call   3ff7 <wait>
  wait();
     c99:	e8 59 33 00 00       	call   3ff7 <wait>
  wait();
     c9e:	e8 54 33 00 00       	call   3ff7 <wait>
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 56 4a 00 	movl   $0x4a56,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 c0 34 00 00       	call   4177 <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid){
     ...
     cf0:	74 20                	je     d12 <exitwait+0x59>
      if(wait() != pid){
     cf2:	e8 00 33 00 00       	call   3ff7 <wait>
     cf7:	3b 45 f0             	cmp    -0x10(%ebp),%eax
     cfa:	74 1b                	je     d17 <exitwait+0x5e>
        printf(1, "wait wrong pid\n");
     cfc:	c7 44 24 04 62 4a 00 	movl   $0x4a62,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 67 34 00 00       	call   4177 <printf>
        return;
     d10:	eb 23                	jmp    d35 <exitwait+0x7c>
      }
    } else {
      exit();
     d12:	e8 d8 32 00 00       	call   3fef <exit>
  for(i = 0; i < 100; i++){
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 72 4a 00 	movl   $0x4a72,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 42 34 00 00       	call   4177 <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 7f 4a 00 	movl   $0x4a7f,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 26 34 00 00       	call   4177 <printf>
  ppid = getpid();
     d51:	e8 19 33 00 00       	call   406f <getpid>
     d56:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if((pid = fork()) == 0){
     d59:	e8 89 32 00 00       	call   3fe7 <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 d5 36 00 00       	call   4463 <malloc>
    ...
    while(m1){
     ...
     da7:	e8 7e 35 00 00       	call   432a <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     dbf:	e8 9f 36 00 00       	call   4463 <malloc>
     dc4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(m1 == 0){
     dc7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
     dcb:	75 24                	jne    df1 <mem+0xba>
      printf(1, "couldn't allocate mem?!!\n");
     dcd:	c7 44 24 04 89 4a 00 	movl   $0x4a89,0x4(%esp)
     dd4:	00 
     dd5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ddc:	e8 96 33 00 00       	call   4177 <printf>
      kill(ppid);
     de1:	8b 45 f0             	mov    -0x10(%ebp),%eax
     de4:	89 04 24             	mov    %eax,(%esp)
     de7:	e8 33 32 00 00       	call   401f <kill>
      exit();
     dec:	e8 fe 31 00 00       	call   3fef <exit>
    }
    free(m1);
     df1:	8b 45 f4             	mov    -0xc(%ebp),%eax
     df4:	89 04 24             	mov    %eax,(%esp)
     df7:	e8 2e 35 00 00       	call   432a <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 a3 4a 00 	movl   $0x4aa3,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 67 33 00 00       	call   4177 <printf>
    exit();
     e10:	e8 da 31 00 00       	call   3fef <exit>
  } else {
    wait();
     e15:	e8 dd 31 00 00       	call   3ff7 <wait>
  }
}
     e1a:	c9                   	leave  
     e1b:	c3                   	ret    
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 ab 4a 00 	movl   $0x4aab,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 41 33 00 00       	call   4177 <printf>

  unlink("sharedfd");
     e36:	c7 04 24 ba 4a 00 00 	movl   $0x4aba,(%esp)
     e3d:	e8 fd 31 00 00       	call   403f <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 ba 4a 00 00 	movl   $0x4aba,(%esp)
     e51:	e8 d9 31 00 00       	call   402f <open>
     e56:	89 45 e8             	mov    %eax,-0x18(%ebp)
  if(fd < 0){
     e59:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
     e5d:	79 19                	jns    e78 <sharedfd+0x5c>
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 c4 4a 00 	movl   $0x4ac4,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 04 33 00 00       	call   4177 <printf>
    return;
     e73:	e9 a0 01 00 00       	jmp    1018 <sharedfd+0x1fc>
  }
  pid = fork();
     e78:	e8 6a 31 00 00       	call   3fe7 <fork>
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     ea4:	e8 99 2f 00 00       	call   3e42 <memset>
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ec7:	e8 43 31 00 00       	call   400f <write>
     ecc:	83 f8 0a             	cmp    $0xa,%eax
     ecf:	74 16                	je     ee7 <sharedfd+0xcb>
      printf(1, "fstests: write sharedfd failed\n");
     ed1:	c7 44 24 04 f0 4a 00 	movl   $0x4af0,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 92 32 00 00       	call   4177 <printf>
      break;
  ...
  if(pid == 0)
    ...
    exit();
     efa:	e8 f0 30 00 00       	call   3fef <exit>
  else
    wait();
     eff:	e8 f3 30 00 00       	call   3ff7 <wait>
  close(fd);
     f04:	8b 45 e8             	mov    -0x18(%ebp),%eax
     f07:	89 04 24             	mov    %eax,(%esp)
     f0a:	e8 08 31 00 00       	call   4017 <close>
  fd = open("sharedfd", 0);
     f0f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     f16:	00 
     f17:	c7 04 24 ba 4a 00 00 	movl   $0x4aba,(%esp)
     f1e:	e8 0c 31 00 00       	call   402f <open>
     f23:	89 45 e8             	mov    %eax,-0x18(%ebp)
  if(fd < 0){
     f26:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
     f2a:	79 19                	jns    f45 <sharedfd+0x129>
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 10 4b 00 	movl   $0x4b10,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 37 32 00 00       	call   4177 <printf>
    return;
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fa4:	e8 5e 30 00 00       	call   4007 <read>
  ...
  close(fd);
     ...
     fb8:	e8 5a 30 00 00       	call   4017 <close>
  unlink("sharedfd");
     fbd:	c7 04 24 ba 4a 00 00 	movl   $0x4aba,(%esp)
     fc4:	e8 76 30 00 00       	call   403f <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 3b 4b 00 	movl   $0x4b3b,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 88 31 00 00       	call   4177 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 48 4b 00 	movl   $0x4b48,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 64 31 00 00       	call   4177 <printf>
    exit();
    1013:	e8 d7 2f 00 00       	call   3fef <exit>
  }
}
    1018:	c9                   	leave  
    1019:	c3                   	ret    
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 5d 4b 00 00 	movl   $0x4b5d,-0x38(%ebp)
    1027:	c7 45 cc 60 4b 00 00 	movl   $0x4b60,-0x34(%ebp)
    102e:	c7 45 d0 63 4b 00 00 	movl   $0x4b63,-0x30(%ebp)
    1035:	c7 45 d4 66 4b 00 00 	movl   $0x4b66,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 69 4b 00 	movl   $0x4b69,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 27 31 00 00       	call   4177 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    106c:	e8 ce 2f 00 00       	call   403f <unlink>

    pid = fork();
    1071:	e8 71 2f 00 00       	call   3fe7 <fork>
    1076:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if(pid < 0){
    1079:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 e5 45 00 	movl   $0x45e5,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 e4 30 00 00       	call   4177 <printf>
      exit();
    1093:	e8 57 2f 00 00       	call   3fef <exit>
    }
    ...
    10b0:	e8 7a 2f 00 00       	call   402f <open>
    10b5:	89 45 dc             	mov    %eax,-0x24(%ebp)
      if(fd < 0){
    10b8:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
    10bc:	79 19                	jns    10d7 <fourfiles+0xbd>
        printf(1, "create failed\n");
    10be:	c7 44 24 04 79 4b 00 	movl   $0x4b79,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 a5 30 00 00       	call   4177 <printf>
        exit();
    10d2:	e8 18 2f 00 00       	call   3fef <exit>
      }
    ...
    10f0:	e8 4d 2d 00 00       	call   3e42 <memset>
      for(i = 0; i < 12; i++){
    ...
    1114:	e8 f6 2e 00 00       	call   400f <write>
    ...
    112c:	c7 44 24 04 88 4b 00 	movl   $0x4b88,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 37 30 00 00       	call   4177 <printf>
          exit();
    1140:	e8 aa 2e 00 00       	call   3fef <exit>
      for(i = 0; i < 12; i++){
    ...
    114d:	7e af                	jle    10fe <fourfiles+0xe4>
      ...
      exit();
    114f:	e8 9b 2e 00 00       	call   3fef <exit>
  for(pi = 0; pi < 4; pi++){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    116b:	e8 87 2e 00 00       	call   3ff7 <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < 2; i++){
    ...
    119e:	e8 8c 2e 00 00       	call   402f <open>
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 99 4b 00 	movl   $0x4b99,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 93 2f 00 00       	call   4177 <printf>
          exit();
    11e4:	e8 06 2e 00 00       	call   3fef <exit>
      for(j = 0; j < n; j++){
    ...
    1211:	e8 f1 2d 00 00       	call   4007 <read>
    ...
    1225:	e8 ed 2d 00 00       	call   4017 <close>
    if(total != 12*500){
    ...
    123a:	c7 44 24 04 a5 4b 00 	movl   $0x4ba5,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 29 2f 00 00       	call   4177 <printf>
      exit();
    124e:	e8 9c 2d 00 00       	call   3fef <exit>
    }
    unlink(fname);
    1253:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1256:	89 04 24             	mov    %eax,(%esp)
    1259:	e8 e1 2d 00 00       	call   403f <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 b6 4b 00 	movl   $0x4bb6,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 f7 2e 00 00       	call   4177 <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1363:	e8 d7 2c 00 00       	call   403f <unlink>
    1368:	85 c0                	test   %eax,%eax
    136a:	79 19                	jns    1385 <createdelete+0x103>
            printf(1, "unlink failed\n");
    136c:	c7 44 24 04 68 46 00 	movl   $0x4668,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 f7 2d 00 00       	call   4177 <printf>
            exit();
    1380:	e8 6a 2c 00 00       	call   3fef <exit>
      for(i = 0; i < N; i++){
    ...
    138d:	0f 8e 5f ff ff ff    	jle    12f2 <createdelete+0x70>
      ...
      exit();
    1393:	e8 57 2c 00 00       	call   3fef <exit>
  for(pi = 0; pi < 4; pi++){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    13af:	e8 43 2c 00 00       	call   3ff7 <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    1408:	e8 22 2c 00 00       	call   402f <open>
    ...
    1429:	c7 44 24 04 d8 4b 00 	movl   $0x4bd8,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 3a 2d 00 00       	call   4177 <printf>
        exit();
    143d:	e8 ad 2b 00 00       	call   3fef <exit>
    ...
    145b:	c7 44 24 04 fc 4b 00 	movl   $0x4bfc,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 08 2d 00 00       	call   4177 <printf>
        exit();
    146f:	e8 7b 2b 00 00       	call   3fef <exit>
      }
      if(fd >= 0)
    ...
    1480:	e8 92 2b 00 00       	call   4017 <close>
    for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    14cb:	e8 6f 2b 00 00       	call   403f <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 1c 4c 00 	movl   $0x4c1c,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 7f 2c 00 00       	call   4177 <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 2d 4c 00 	movl   $0x4c2d,0x4(%esp)
    1507:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    151b:	00 
    151c:	c7 04 24 3e 4c 00 00 	movl   $0x4c3e,(%esp)
    1523:	e8 07 2b 00 00       	call   402f <open>
    1528:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    152b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    152f:	79 19                	jns    154a <unlinkread+0x50>
    printf(1, "create unlinkread failed\n");
    1531:	c7 44 24 04 49 4c 00 	movl   $0x4c49,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 32 2c 00 00       	call   4177 <printf>
    exit();
    1545:	e8 a5 2a 00 00       	call   3fef <exit>
  }
  write(fd, "hello", 5);
    154a:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%esp)
    1551:	00 
    1552:	c7 44 24 04 63 4c 00 	movl   $0x4c63,0x4(%esp)
    1559:	00 
    155a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    155d:	89 04 24             	mov    %eax,(%esp)
    1560:	e8 aa 2a 00 00       	call   400f <write>
  close(fd);
    1565:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1568:	89 04 24             	mov    %eax,(%esp)
    156b:	e8 a7 2a 00 00       	call   4017 <close>

  fd = open("unlinkread", O_RDWR);
    1570:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
    1577:	00 
    1578:	c7 04 24 3e 4c 00 00 	movl   $0x4c3e,(%esp)
    157f:	e8 ab 2a 00 00       	call   402f <open>
    1584:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1587:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    158b:	79 19                	jns    15a6 <unlinkread+0xac>
    printf(1, "open unlinkread failed\n");
    158d:	c7 44 24 04 69 4c 00 	movl   $0x4c69,0x4(%esp)
    1594:	00 
    1595:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    159c:	e8 d6 2b 00 00       	call   4177 <printf>
    exit();
    15a1:	e8 49 2a 00 00       	call   3fef <exit>
  }
  if(unlink("unlinkread") != 0){
    15a6:	c7 04 24 3e 4c 00 00 	movl   $0x4c3e,(%esp)
    15ad:	e8 8d 2a 00 00       	call   403f <unlink>
    15b2:	85 c0                	test   %eax,%eax
    15b4:	74 19                	je     15cf <unlinkread+0xd5>
    printf(1, "unlink unlinkread failed\n");
    15b6:	c7 44 24 04 81 4c 00 	movl   $0x4c81,0x4(%esp)
    15bd:	00 
    15be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15c5:	e8 ad 2b 00 00       	call   4177 <printf>
    exit();
    15ca:	e8 20 2a 00 00       	call   3fef <exit>
  }

  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    15cf:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    15d6:	00 
    15d7:	c7 04 24 3e 4c 00 00 	movl   $0x4c3e,(%esp)
    15de:	e8 4c 2a 00 00       	call   402f <open>
    15e3:	89 45 f0             	mov    %eax,-0x10(%ebp)
  write(fd1, "yyy", 3);
    15e6:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    15ed:	00 
    15ee:	c7 44 24 04 9b 4c 00 	movl   $0x4c9b,0x4(%esp)
    15f5:	00 
    15f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    15f9:	89 04 24             	mov    %eax,(%esp)
    15fc:	e8 0e 2a 00 00       	call   400f <write>
  close(fd1);
    1601:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1604:	89 04 24             	mov    %eax,(%esp)
    1607:	e8 0b 2a 00 00       	call   4017 <close>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1622:	e8 e0 29 00 00       	call   4007 <read>
    1627:	83 f8 05             	cmp    $0x5,%eax
    162a:	74 19                	je     1645 <unlinkread+0x14b>
    printf(1, "unlinkread read failed");
    162c:	c7 44 24 04 9f 4c 00 	movl   $0x4c9f,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 37 2b 00 00       	call   4177 <printf>
    exit();
    1640:	e8 aa 29 00 00       	call   3fef <exit>
  }
  if(buf[0] != 'h'){
    ...
    1650:	c7 44 24 04 b6 4c 00 	movl   $0x4cb6,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 13 2b 00 00       	call   4177 <printf>
    exit();
    1664:	e8 86 29 00 00       	call   3fef <exit>
  }
  if(write(fd, buf, 10) != 10){
    ...
    167f:	e8 8b 29 00 00       	call   400f <write>
    1684:	83 f8 0a             	cmp    $0xa,%eax
    1687:	74 19                	je     16a2 <unlinkread+0x1a8>
    printf(1, "unlinkread write failed\n");
    1689:	c7 44 24 04 cd 4c 00 	movl   $0x4ccd,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 da 2a 00 00       	call   4177 <printf>
    exit();
    169d:	e8 4d 29 00 00       	call   3fef <exit>
  }
  close(fd);
    16a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    16a5:	89 04 24             	mov    %eax,(%esp)
    16a8:	e8 6a 29 00 00       	call   4017 <close>
  unlink("unlinkread");
    16ad:	c7 04 24 3e 4c 00 00 	movl   $0x4c3e,(%esp)
    16b4:	e8 86 29 00 00       	call   403f <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 e6 4c 00 	movl   $0x4ce6,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 aa 2a 00 00       	call   4177 <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 f5 4c 00 	movl   $0x4cf5,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 8e 2a 00 00       	call   4177 <printf>

  unlink("lf1");
    16e9:	c7 04 24 ff 4c 00 00 	movl   $0x4cff,(%esp)
    16f0:	e8 4a 29 00 00       	call   403f <unlink>
  unlink("lf2");
    16f5:	c7 04 24 03 4d 00 00 	movl   $0x4d03,(%esp)
    16fc:	e8 3e 29 00 00       	call   403f <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 ff 4c 00 00 	movl   $0x4cff,(%esp)
    1710:	e8 1a 29 00 00       	call   402f <open>
    1715:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1718:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    171c:	79 19                	jns    1737 <linktest+0x68>
    printf(1, "create lf1 failed\n");
    171e:	c7 44 24 04 07 4d 00 	movl   $0x4d07,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 45 2a 00 00       	call   4177 <printf>
    exit();
    1732:	e8 b8 28 00 00       	call   3fef <exit>
  }
  if(write(fd, "hello", 5) != 5){
    1737:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%esp)
    173e:	00 
    173f:	c7 44 24 04 63 4c 00 	movl   $0x4c63,0x4(%esp)
    1746:	00 
    1747:	8b 45 f4             	mov    -0xc(%ebp),%eax
    174a:	89 04 24             	mov    %eax,(%esp)
    174d:	e8 bd 28 00 00       	call   400f <write>
    1752:	83 f8 05             	cmp    $0x5,%eax
    1755:	74 19                	je     1770 <linktest+0xa1>
    printf(1, "write lf1 failed\n");
    1757:	c7 44 24 04 1a 4d 00 	movl   $0x4d1a,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 0c 2a 00 00       	call   4177 <printf>
    exit();
    176b:	e8 7f 28 00 00       	call   3fef <exit>
  }
  close(fd);
    1770:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1773:	89 04 24             	mov    %eax,(%esp)
    1776:	e8 9c 28 00 00       	call   4017 <close>

  if(link("lf1", "lf2") < 0){
    177b:	c7 44 24 04 03 4d 00 	movl   $0x4d03,0x4(%esp)
    1782:	00 
    1783:	c7 04 24 ff 4c 00 00 	movl   $0x4cff,(%esp)
    178a:	e8 c0 28 00 00       	call   404f <link>
    178f:	85 c0                	test   %eax,%eax
    1791:	79 19                	jns    17ac <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    1793:	c7 44 24 04 2c 4d 00 	movl   $0x4d2c,0x4(%esp)
    179a:	00 
    179b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17a2:	e8 d0 29 00 00       	call   4177 <printf>
    exit();
    17a7:	e8 43 28 00 00       	call   3fef <exit>
  }
  unlink("lf1");
    17ac:	c7 04 24 ff 4c 00 00 	movl   $0x4cff,(%esp)
    17b3:	e8 87 28 00 00       	call   403f <unlink>

  if(open("lf1", 0) >= 0){
    17b8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    17bf:	00 
    17c0:	c7 04 24 ff 4c 00 00 	movl   $0x4cff,(%esp)
    17c7:	e8 63 28 00 00       	call   402f <open>
    17cc:	85 c0                	test   %eax,%eax
    17ce:	78 19                	js     17e9 <linktest+0x11a>
    printf(1, "unlinked lf1 but it is still there!\n");
    17d0:	c7 44 24 04 44 4d 00 	movl   $0x4d44,0x4(%esp)
    17d7:	00 
    17d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17df:	e8 93 29 00 00       	call   4177 <printf>
    exit();
    17e4:	e8 06 28 00 00       	call   3fef <exit>
  }

  fd = open("lf2", 0);
    17e9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    17f0:	00 
    17f1:	c7 04 24 03 4d 00 00 	movl   $0x4d03,(%esp)
    17f8:	e8 32 28 00 00       	call   402f <open>
    17fd:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1800:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1804:	79 19                	jns    181f <linktest+0x150>
    printf(1, "open lf2 failed\n");
    1806:	c7 44 24 04 69 4d 00 	movl   $0x4d69,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 5d 29 00 00       	call   4177 <printf>
    exit();
    181a:	e8 d0 27 00 00       	call   3fef <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1835:	e8 cd 27 00 00       	call   4007 <read>
    183a:	83 f8 05             	cmp    $0x5,%eax
    183d:	74 19                	je     1858 <linktest+0x189>
    printf(1, "read lf2 failed\n");
    183f:	c7 44 24 04 7a 4d 00 	movl   $0x4d7a,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 24 29 00 00       	call   4177 <printf>
    exit();
    1853:	e8 97 27 00 00       	call   3fef <exit>
  }
  close(fd);
    1858:	8b 45 f4             	mov    -0xc(%ebp),%eax
    185b:	89 04 24             	mov    %eax,(%esp)
    185e:	e8 b4 27 00 00       	call   4017 <close>

  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 03 4d 00 	movl   $0x4d03,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 03 4d 00 00 	movl   $0x4d03,(%esp)
    1872:	e8 d8 27 00 00       	call   404f <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 8b 4d 00 	movl   $0x4d8b,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 e8 28 00 00       	call   4177 <printf>
    exit();
    188f:	e8 5b 27 00 00       	call   3fef <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 03 4d 00 00 	movl   $0x4d03,(%esp)
    189b:	e8 9f 27 00 00       	call   403f <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 ff 4c 00 	movl   $0x4cff,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 03 4d 00 00 	movl   $0x4d03,(%esp)
    18af:	e8 9b 27 00 00       	call   404f <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 ac 4d 00 	movl   $0x4dac,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 ab 28 00 00       	call   4177 <printf>
    exit();
    18cc:	e8 1e 27 00 00       	call   3fef <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 ff 4c 00 	movl   $0x4cff,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 cf 4d 00 00 	movl   $0x4dcf,(%esp)
    18e0:	e8 6a 27 00 00       	call   404f <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 d1 4d 00 	movl   $0x4dd1,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 7a 28 00 00       	call   4177 <printf>
    exit();
    18fd:	e8 ed 26 00 00       	call   3fef <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 ed 4d 00 	movl   $0x4ded,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 61 28 00 00       	call   4177 <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 fa 4d 00 	movl   $0x4dfa,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 45 28 00 00       	call   4177 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1955:	e8 e5 26 00 00       	call   403f <unlink>
    pid = fork();
    195a:	e8 88 26 00 00       	call   3fe7 <fork>
    ...
    1991:	c7 04 24 0a 4e 00 00 	movl   $0x4e0a,(%esp)
    1998:	e8 b2 26 00 00       	call   404f <link>
    ...
    19d4:	c7 04 24 0a 4e 00 00 	movl   $0x4e0a,(%esp)
    19db:	e8 6f 26 00 00       	call   404f <link>
    ...
    19f0:	e8 3a 26 00 00       	call   402f <open>
    ...
    1a05:	c7 44 24 04 0d 4e 00 	movl   $0x4e0d,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 5e 27 00 00       	call   4177 <printf>
        exit();
    1a19:	e8 d1 25 00 00       	call   3fef <exit>
      }
      close(fd);
    1a1e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1a21:	89 04 24             	mov    %eax,(%esp)
    1a24:	e8 ee 25 00 00       	call   4017 <close>
    }
    if(pid == 0)
    1a29:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1a2d:	75 05                	jne    1a34 <concreate+0x11c>
      exit();
    1a2f:	e8 bb 25 00 00       	call   3fef <exit>
    else
      wait();
    1a34:	e8 be 25 00 00       	call   3ff7 <wait>
  for(i = 0; i < 40; i++){
  ...
  memset(fa, 0, sizeof(fa));
    ...
    1a5d:	e8 e0 23 00 00       	call   3e42 <memset>
  fd = open(".", 0);
    1a62:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    1a69:	00 
    1a6a:	c7 04 24 cf 4d 00 00 	movl   $0x4dcf,(%esp)
    1a71:	e8 b9 25 00 00       	call   402f <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 29 4e 00 	movl   $0x4e29,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 97 26 00 00       	call   4177 <printf>
        exit();
    1ae0:	e8 0a 25 00 00       	call   3fef <exit>
      }
      if(fa[i]){
    ...
    1afe:	c7 44 24 04 42 4e 00 	movl   $0x4e42,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 65 26 00 00       	call   4177 <printf>
        exit();
    1b12:	e8 d8 24 00 00       	call   3fef <exit>
      }
      fa[i] = 1;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1b3b:	e8 c7 24 00 00       	call   4007 <read>
  ...
  close(fd);
    ...
    1b4e:	e8 c4 24 00 00       	call   4017 <close>

  if(n != 40){
    1b53:	83 7d f0 28          	cmpl   $0x28,-0x10(%ebp)
    1b57:	74 19                	je     1b72 <concreate+0x25a>
    printf(1, "concreate not enough files in directory listing\n");
    1b59:	c7 44 24 04 60 4e 00 	movl   $0x4e60,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 0a 26 00 00       	call   4177 <printf>
    exit();
    1b6d:	e8 7d 24 00 00       	call   3fef <exit>
  }
  ...
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    1b87:	e8 5b 24 00 00       	call   3fe7 <fork>
    1b8c:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(pid < 0){
    1b8f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 e5 45 00 	movl   $0x45e5,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 ce 25 00 00       	call   4177 <printf>
      exit();
    1ba9:	e8 41 24 00 00       	call   3fef <exit>
    }
    if(((i % 3) == 0 && pid == 0) ||
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 91 4e 00 	movl   $0x4e91,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 ae 24 00 00       	call   4177 <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 9f 4e 00 	movl   $0x4e9f,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 92 24 00 00       	call   4177 <printf>

  unlink("x");
    1ce5:	c7 04 24 1b 4a 00 00 	movl   $0x4a1b,(%esp)
    1cec:	e8 4e 23 00 00       	call   403f <unlink>
  pid = fork();
    1cf1:	e8 f1 22 00 00       	call   3fe7 <fork>
    1cf6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(pid < 0){
    1cf9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1cfd:	79 19                	jns    1d18 <linkunlink+0x4d>
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 e5 45 00 	movl   $0x45e5,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 64 24 00 00       	call   4177 <printf>
    exit();
    1d13:	e8 d7 22 00 00       	call   3fef <exit>
  }
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 1b 4a 00 00 	movl   $0x4a1b,(%esp)
    1d75:	e8 b5 22 00 00       	call   402f <open>
    1d7a:	89 04 24             	mov    %eax,(%esp)
    1d7d:	e8 95 22 00 00       	call   4017 <close>
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 1b 4a 00 	movl   $0x4a1b,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 b0 4e 00 00 	movl   $0x4eb0,(%esp)
    1db0:	e8 9a 22 00 00       	call   404f <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 1b 4a 00 00 	movl   $0x4a1b,(%esp)
    1dbe:	e8 7c 22 00 00       	call   403f <unlink>
  for(i = 0; i < 100; i++){
  ...
  if(pid)
    ...
    wait();
    1dd7:	e8 1b 22 00 00       	call   3ff7 <wait>
    1ddc:	eb 05                	jmp    1de3 <linkunlink+0x118>
  else
    exit();
    1dde:	e8 0c 22 00 00       	call   3fef <exit>

  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 b4 4e 00 	movl   $0x4eb4,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 80 23 00 00       	call   4177 <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 c3 4e 00 	movl   $0x4ec3,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 64 23 00 00       	call   4177 <printf>
  unlink("bd");
    1e13:	c7 04 24 d0 4e 00 00 	movl   $0x4ed0,(%esp)
    1e1a:	e8 20 22 00 00       	call   403f <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 d0 4e 00 00 	movl   $0x4ed0,(%esp)
    1e2e:	e8 fc 21 00 00       	call   402f <open>
    1e33:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(fd < 0){
    1e36:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1e3a:	79 19                	jns    1e55 <bigdir+0x5c>
    printf(1, "bigdir create failed\n");
    1e3c:	c7 44 24 04 d3 4e 00 	movl   $0x4ed3,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 27 23 00 00       	call   4177 <printf>
    exit();
    1e50:	e8 9a 21 00 00       	call   3fef <exit>
  }
  close(fd);
    1e55:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e58:	89 04 24             	mov    %eax,(%esp)
    1e5b:	e8 b7 21 00 00       	call   4017 <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1ea0:	c7 04 24 d0 4e 00 00 	movl   $0x4ed0,(%esp)
    1ea7:	e8 a3 21 00 00       	call   404f <link>
    1eac:	85 c0                	test   %eax,%eax
    1eae:	74 19                	je     1ec9 <bigdir+0xd0>
      printf(1, "bigdir link failed\n");
    1eb0:	c7 44 24 04 e9 4e 00 	movl   $0x4ee9,0x4(%esp)
    1eb7:	00 
    1eb8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ebf:	e8 b3 22 00 00       	call   4177 <printf>
      exit();
    1ec4:	e8 26 21 00 00       	call   3fef <exit>
  for(i = 0; i < 500; i++){
  ...
  unlink("bd");
    1ed6:	c7 04 24 d0 4e 00 00 	movl   $0x4ed0,(%esp)
    1edd:	e8 5d 21 00 00       	call   403f <unlink>
  for(i = 0; i < 500; i++){
    ...
    1f21:	e8 19 21 00 00       	call   403f <unlink>
    1f26:	85 c0                	test   %eax,%eax
    1f28:	74 19                	je     1f43 <bigdir+0x14a>
      printf(1, "bigdir unlink failed");
    1f2a:	c7 44 24 04 fd 4e 00 	movl   $0x4efd,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 39 22 00 00       	call   4177 <printf>
      exit();
    1f3e:	e8 ac 20 00 00       	call   3fef <exit>
  for(i = 0; i < 500; i++){
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 12 4f 00 	movl   $0x4f12,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 13 22 00 00       	call   4177 <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 1d 4f 00 	movl   $0x4f1d,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 f7 21 00 00       	call   4177 <printf>

  unlink("ff");
    1f80:	c7 04 24 2a 4f 00 00 	movl   $0x4f2a,(%esp)
    1f87:	e8 b3 20 00 00       	call   403f <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 2d 4f 00 00 	movl   $0x4f2d,(%esp)
    1f93:	e8 bf 20 00 00       	call   4057 <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 30 4f 00 	movl   $0x4f30,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 c7 21 00 00       	call   4177 <printf>
    exit();
    1fb0:	e8 3a 20 00 00       	call   3fef <exit>
  }

  fd = open("dd/ff", O_CREATE | O_RDWR);
    1fb5:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1fbc:	00 
    1fbd:	c7 04 24 48 4f 00 00 	movl   $0x4f48,(%esp)
    1fc4:	e8 66 20 00 00       	call   402f <open>
    1fc9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1fcc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1fd0:	79 19                	jns    1feb <subdir+0x85>
    printf(1, "create dd/ff failed\n");
    1fd2:	c7 44 24 04 4e 4f 00 	movl   $0x4f4e,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 91 21 00 00       	call   4177 <printf>
    exit();
    1fe6:	e8 04 20 00 00       	call   3fef <exit>
  }
  write(fd, "ff", 2);
    1feb:	c7 44 24 08 02 00 00 	movl   $0x2,0x8(%esp)
    1ff2:	00 
    1ff3:	c7 44 24 04 2a 4f 00 	movl   $0x4f2a,0x4(%esp)
    1ffa:	00 
    1ffb:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1ffe:	89 04 24             	mov    %eax,(%esp)
    2001:	e8 09 20 00 00       	call   400f <write>
  close(fd);
    2006:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2009:	89 04 24             	mov    %eax,(%esp)
    200c:	e8 06 20 00 00       	call   4017 <close>

  if(unlink("dd") >= 0){
    2011:	c7 04 24 2d 4f 00 00 	movl   $0x4f2d,(%esp)
    2018:	e8 22 20 00 00       	call   403f <unlink>
    201d:	85 c0                	test   %eax,%eax
    201f:	78 19                	js     203a <subdir+0xd4>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    2021:	c7 44 24 04 64 4f 00 	movl   $0x4f64,0x4(%esp)
    2028:	00 
    2029:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2030:	e8 42 21 00 00       	call   4177 <printf>
    exit();
    2035:	e8 b5 1f 00 00       	call   3fef <exit>
  }

  if(mkdir("/dd/dd") != 0){
    203a:	c7 04 24 8a 4f 00 00 	movl   $0x4f8a,(%esp)
    2041:	e8 11 20 00 00       	call   4057 <mkdir>
    2046:	85 c0                	test   %eax,%eax
    2048:	74 19                	je     2063 <subdir+0xfd>
    printf(1, "subdir mkdir dd/dd failed\n");
    204a:	c7 44 24 04 91 4f 00 	movl   $0x4f91,0x4(%esp)
    2051:	00 
    2052:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2059:	e8 19 21 00 00       	call   4177 <printf>
    exit();
    205e:	e8 8c 1f 00 00       	call   3fef <exit>
  }

  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    2063:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    206a:	00 
    206b:	c7 04 24 ac 4f 00 00 	movl   $0x4fac,(%esp)
    2072:	e8 b8 1f 00 00       	call   402f <open>
    2077:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    207a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    207e:	79 19                	jns    2099 <subdir+0x133>
    printf(1, "create dd/dd/ff failed\n");
    2080:	c7 44 24 04 b5 4f 00 	movl   $0x4fb5,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 e3 20 00 00       	call   4177 <printf>
    exit();
    2094:	e8 56 1f 00 00       	call   3fef <exit>
  }
  write(fd, "FF", 2);
    2099:	c7 44 24 08 02 00 00 	movl   $0x2,0x8(%esp)
    20a0:	00 
    20a1:	c7 44 24 04 cd 4f 00 	movl   $0x4fcd,0x4(%esp)
    20a8:	00 
    20a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20ac:	89 04 24             	mov    %eax,(%esp)
    20af:	e8 5b 1f 00 00       	call   400f <write>
  close(fd);
    20b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20b7:	89 04 24             	mov    %eax,(%esp)
    20ba:	e8 58 1f 00 00       	call   4017 <close>

  fd = open("dd/dd/../ff", 0);
    20bf:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    20c6:	00 
    20c7:	c7 04 24 d0 4f 00 00 	movl   $0x4fd0,(%esp)
    20ce:	e8 5c 1f 00 00       	call   402f <open>
    20d3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    20d6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    20da:	79 19                	jns    20f5 <subdir+0x18f>
    printf(1, "open dd/dd/../ff failed\n");
    20dc:	c7 44 24 04 dc 4f 00 	movl   $0x4fdc,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 87 20 00 00       	call   4177 <printf>
    exit();
    20f0:	e8 fa 1e 00 00       	call   3fef <exit>
  }
  cc = read(fd, buf, sizeof(buf));
    ...
    210b:	e8 f7 1e 00 00       	call   4007 <read>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2124:	c7 44 24 04 f5 4f 00 	movl   $0x4ff5,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 3f 20 00 00       	call   4177 <printf>
    exit();
    2138:	e8 b2 1e 00 00       	call   3fef <exit>
  }
  close(fd);
    213d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2140:	89 04 24             	mov    %eax,(%esp)
    2143:	e8 cf 1e 00 00       	call   4017 <close>

  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2148:	c7 44 24 04 10 50 00 	movl   $0x5010,0x4(%esp)
    214f:	00 
    2150:	c7 04 24 ac 4f 00 00 	movl   $0x4fac,(%esp)
    2157:	e8 f3 1e 00 00       	call   404f <link>
    215c:	85 c0                	test   %eax,%eax
    215e:	74 19                	je     2179 <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2160:	c7 44 24 04 1c 50 00 	movl   $0x501c,0x4(%esp)
    2167:	00 
    2168:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    216f:	e8 03 20 00 00       	call   4177 <printf>
    exit();
    2174:	e8 76 1e 00 00       	call   3fef <exit>
  }

  if(unlink("dd/dd/ff") != 0){
    2179:	c7 04 24 ac 4f 00 00 	movl   $0x4fac,(%esp)
    2180:	e8 ba 1e 00 00       	call   403f <unlink>
    2185:	85 c0                	test   %eax,%eax
    2187:	74 19                	je     21a2 <subdir+0x23c>
    printf(1, "unlink dd/dd/ff failed\n");
    2189:	c7 44 24 04 3d 50 00 	movl   $0x503d,0x4(%esp)
    2190:	00 
    2191:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2198:	e8 da 1f 00 00       	call   4177 <printf>
    exit();
    219d:	e8 4d 1e 00 00       	call   3fef <exit>
  }
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    21a2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    21a9:	00 
    21aa:	c7 04 24 ac 4f 00 00 	movl   $0x4fac,(%esp)
    21b1:	e8 79 1e 00 00       	call   402f <open>
    21b6:	85 c0                	test   %eax,%eax
    21b8:	78 19                	js     21d3 <subdir+0x26d>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    21ba:	c7 44 24 04 58 50 00 	movl   $0x5058,0x4(%esp)
    21c1:	00 
    21c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    21c9:	e8 a9 1f 00 00       	call   4177 <printf>
    exit();
    21ce:	e8 1c 1e 00 00       	call   3fef <exit>
  }

  if(chdir("dd") != 0){
    21d3:	c7 04 24 2d 4f 00 00 	movl   $0x4f2d,(%esp)
    21da:	e8 80 1e 00 00       	call   405f <chdir>
    21df:	85 c0                	test   %eax,%eax
    21e1:	74 19                	je     21fc <subdir+0x296>
    printf(1, "chdir dd failed\n");
    21e3:	c7 44 24 04 7c 50 00 	movl   $0x507c,0x4(%esp)
    21ea:	00 
    21eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    21f2:	e8 80 1f 00 00       	call   4177 <printf>
    exit();
    21f7:	e8 f3 1d 00 00       	call   3fef <exit>
  }
  if(chdir("dd/../../dd") != 0){
    21fc:	c7 04 24 8d 50 00 00 	movl   $0x508d,(%esp)
    2203:	e8 57 1e 00 00       	call   405f <chdir>
    2208:	85 c0                	test   %eax,%eax
    220a:	74 19                	je     2225 <subdir+0x2bf>
    printf(1, "chdir dd/../../dd failed\n");
    220c:	c7 44 24 04 99 50 00 	movl   $0x5099,0x4(%esp)
    2213:	00 
    2214:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    221b:	e8 57 1f 00 00       	call   4177 <printf>
    exit();
    2220:	e8 ca 1d 00 00       	call   3fef <exit>
  }
  if(chdir("dd/../../../dd") != 0){
    2225:	c7 04 24 b3 50 00 00 	movl   $0x50b3,(%esp)
    222c:	e8 2e 1e 00 00       	call   405f <chdir>
    2231:	85 c0                	test   %eax,%eax
    2233:	74 19                	je     224e <subdir+0x2e8>
    printf(1, "chdir dd/../../dd failed\n");
    2235:	c7 44 24 04 99 50 00 	movl   $0x5099,0x4(%esp)
    223c:	00 
    223d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2244:	e8 2e 1f 00 00       	call   4177 <printf>
    exit();
    2249:	e8 a1 1d 00 00       	call   3fef <exit>
  }
  if(chdir("./..") != 0){
    224e:	c7 04 24 c2 50 00 00 	movl   $0x50c2,(%esp)
    2255:	e8 05 1e 00 00       	call   405f <chdir>
    225a:	85 c0                	test   %eax,%eax
    225c:	74 19                	je     2277 <subdir+0x311>
    printf(1, "chdir ./.. failed\n");
    225e:	c7 44 24 04 c7 50 00 	movl   $0x50c7,0x4(%esp)
    2265:	00 
    2266:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    226d:	e8 05 1f 00 00       	call   4177 <printf>
    exit();
    2272:	e8 78 1d 00 00       	call   3fef <exit>
  }

  fd = open("dd/dd/ffff", 0);
    2277:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    227e:	00 
    227f:	c7 04 24 10 50 00 00 	movl   $0x5010,(%esp)
    2286:	e8 a4 1d 00 00       	call   402f <open>
    228b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    228e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2292:	79 19                	jns    22ad <subdir+0x347>
    printf(1, "open dd/dd/ffff failed\n");
    2294:	c7 44 24 04 da 50 00 	movl   $0x50da,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 cf 1e 00 00       	call   4177 <printf>
    exit();
    22a8:	e8 42 1d 00 00       	call   3fef <exit>
  }
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22c3:	e8 3f 1d 00 00       	call   4007 <read>
    22c8:	83 f8 02             	cmp    $0x2,%eax
    22cb:	74 19                	je     22e6 <subdir+0x380>
    printf(1, "read dd/dd/ffff wrong len\n");
    22cd:	c7 44 24 04 f2 50 00 	movl   $0x50f2,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 96 1e 00 00       	call   4177 <printf>
    exit();
    22e1:	e8 09 1d 00 00       	call   3fef <exit>
  }
  close(fd);
    22e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    22e9:	89 04 24             	mov    %eax,(%esp)
    22ec:	e8 26 1d 00 00       	call   4017 <close>

  if(open("dd/dd/ff", O_RDONLY) >= 0){
    22f1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    22f8:	00 
    22f9:	c7 04 24 ac 4f 00 00 	movl   $0x4fac,(%esp)
    2300:	e8 2a 1d 00 00       	call   402f <open>
    2305:	85 c0                	test   %eax,%eax
    2307:	78 19                	js     2322 <subdir+0x3bc>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2309:	c7 44 24 04 10 51 00 	movl   $0x5110,0x4(%esp)
    2310:	00 
    2311:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2318:	e8 5a 1e 00 00       	call   4177 <printf>
    exit();
    231d:	e8 cd 1c 00 00       	call   3fef <exit>
  }

  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    2322:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2329:	00 
    232a:	c7 04 24 35 51 00 00 	movl   $0x5135,(%esp)
    2331:	e8 f9 1c 00 00       	call   402f <open>
    2336:	85 c0                	test   %eax,%eax
    2338:	78 19                	js     2353 <subdir+0x3ed>
    printf(1, "create dd/ff/ff succeeded!\n");
    233a:	c7 44 24 04 3e 51 00 	movl   $0x513e,0x4(%esp)
    2341:	00 
    2342:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2349:	e8 29 1e 00 00       	call   4177 <printf>
    exit();
    234e:	e8 9c 1c 00 00       	call   3fef <exit>
  }
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    2353:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    235a:	00 
    235b:	c7 04 24 5a 51 00 00 	movl   $0x515a,(%esp)
    2362:	e8 c8 1c 00 00       	call   402f <open>
    2367:	85 c0                	test   %eax,%eax
    2369:	78 19                	js     2384 <subdir+0x41e>
    printf(1, "create dd/xx/ff succeeded!\n");
    236b:	c7 44 24 04 63 51 00 	movl   $0x5163,0x4(%esp)
    2372:	00 
    2373:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    237a:	e8 f8 1d 00 00       	call   4177 <printf>
    exit();
    237f:	e8 6b 1c 00 00       	call   3fef <exit>
  }
  if(open("dd", O_CREATE) >= 0){
    2384:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    238b:	00 
    238c:	c7 04 24 2d 4f 00 00 	movl   $0x4f2d,(%esp)
    2393:	e8 97 1c 00 00       	call   402f <open>
    2398:	85 c0                	test   %eax,%eax
    239a:	78 19                	js     23b5 <subdir+0x44f>
    printf(1, "create dd succeeded!\n");
    239c:	c7 44 24 04 7f 51 00 	movl   $0x517f,0x4(%esp)
    23a3:	00 
    23a4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23ab:	e8 c7 1d 00 00       	call   4177 <printf>
    exit();
    23b0:	e8 3a 1c 00 00       	call   3fef <exit>
  }
  if(open("dd", O_RDWR) >= 0){
    23b5:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
    23bc:	00 
    23bd:	c7 04 24 2d 4f 00 00 	movl   $0x4f2d,(%esp)
    23c4:	e8 66 1c 00 00       	call   402f <open>
    23c9:	85 c0                	test   %eax,%eax
    23cb:	78 19                	js     23e6 <subdir+0x480>
    printf(1, "open dd rdwr succeeded!\n");
    23cd:	c7 44 24 04 95 51 00 	movl   $0x5195,0x4(%esp)
    23d4:	00 
    23d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23dc:	e8 96 1d 00 00       	call   4177 <printf>
    exit();
    23e1:	e8 09 1c 00 00       	call   3fef <exit>
  }
  if(open("dd", O_WRONLY) >= 0){
    23e6:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
    23ed:	00 
    23ee:	c7 04 24 2d 4f 00 00 	movl   $0x4f2d,(%esp)
    23f5:	e8 35 1c 00 00       	call   402f <open>
    23fa:	85 c0                	test   %eax,%eax
    23fc:	78 19                	js     2417 <subdir+0x4b1>
    printf(1, "open dd wronly succeeded!\n");
    23fe:	c7 44 24 04 ae 51 00 	movl   $0x51ae,0x4(%esp)
    2405:	00 
    2406:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    240d:	e8 65 1d 00 00       	call   4177 <printf>
    exit();
    2412:	e8 d8 1b 00 00       	call   3fef <exit>
  }
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2417:	c7 44 24 04 c9 51 00 	movl   $0x51c9,0x4(%esp)
    241e:	00 
    241f:	c7 04 24 35 51 00 00 	movl   $0x5135,(%esp)
    2426:	e8 24 1c 00 00       	call   404f <link>
    242b:	85 c0                	test   %eax,%eax
    242d:	75 19                	jne    2448 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    242f:	c7 44 24 04 d4 51 00 	movl   $0x51d4,0x4(%esp)
    2436:	00 
    2437:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    243e:	e8 34 1d 00 00       	call   4177 <printf>
    exit();
    2443:	e8 a7 1b 00 00       	call   3fef <exit>
  }
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2448:	c7 44 24 04 c9 51 00 	movl   $0x51c9,0x4(%esp)
    244f:	00 
    2450:	c7 04 24 5a 51 00 00 	movl   $0x515a,(%esp)
    2457:	e8 f3 1b 00 00       	call   404f <link>
    245c:	85 c0                	test   %eax,%eax
    245e:	75 19                	jne    2479 <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2460:	c7 44 24 04 f8 51 00 	movl   $0x51f8,0x4(%esp)
    2467:	00 
    2468:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    246f:	e8 03 1d 00 00       	call   4177 <printf>
    exit();
    2474:	e8 76 1b 00 00       	call   3fef <exit>
  }
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2479:	c7 44 24 04 10 50 00 	movl   $0x5010,0x4(%esp)
    2480:	00 
    2481:	c7 04 24 48 4f 00 00 	movl   $0x4f48,(%esp)
    2488:	e8 c2 1b 00 00       	call   404f <link>
    248d:	85 c0                	test   %eax,%eax
    248f:	75 19                	jne    24aa <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2491:	c7 44 24 04 1c 52 00 	movl   $0x521c,0x4(%esp)
    2498:	00 
    2499:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24a0:	e8 d2 1c 00 00       	call   4177 <printf>
    exit();
    24a5:	e8 45 1b 00 00       	call   3fef <exit>
  }
  if(mkdir("dd/ff/ff") == 0){
    24aa:	c7 04 24 35 51 00 00 	movl   $0x5135,(%esp)
    24b1:	e8 a1 1b 00 00       	call   4057 <mkdir>
    24b6:	85 c0                	test   %eax,%eax
    24b8:	75 19                	jne    24d3 <subdir+0x56d>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    24ba:	c7 44 24 04 3e 52 00 	movl   $0x523e,0x4(%esp)
    24c1:	00 
    24c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24c9:	e8 a9 1c 00 00       	call   4177 <printf>
    exit();
    24ce:	e8 1c 1b 00 00       	call   3fef <exit>
  }
  if(mkdir("dd/xx/ff") == 0){
    24d3:	c7 04 24 5a 51 00 00 	movl   $0x515a,(%esp)
    24da:	e8 78 1b 00 00       	call   4057 <mkdir>
    24df:	85 c0                	test   %eax,%eax
    24e1:	75 19                	jne    24fc <subdir+0x596>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    24e3:	c7 44 24 04 59 52 00 	movl   $0x5259,0x4(%esp)
    24ea:	00 
    24eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24f2:	e8 80 1c 00 00       	call   4177 <printf>
    exit();
    24f7:	e8 f3 1a 00 00       	call   3fef <exit>
  }
  if(mkdir("dd/dd/ffff") == 0){
    24fc:	c7 04 24 10 50 00 00 	movl   $0x5010,(%esp)
    2503:	e8 4f 1b 00 00       	call   4057 <mkdir>
    2508:	85 c0                	test   %eax,%eax
    250a:	75 19                	jne    2525 <subdir+0x5bf>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    250c:	c7 44 24 04 74 52 00 	movl   $0x5274,0x4(%esp)
    2513:	00 
    2514:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251b:	e8 57 1c 00 00       	call   4177 <printf>
    exit();
    2520:	e8 ca 1a 00 00       	call   3fef <exit>
  }
  if(unlink("dd/xx/ff") == 0){
    2525:	c7 04 24 5a 51 00 00 	movl   $0x515a,(%esp)
    252c:	e8 0e 1b 00 00       	call   403f <unlink>
    2531:	85 c0                	test   %eax,%eax
    2533:	75 19                	jne    254e <subdir+0x5e8>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2535:	c7 44 24 04 91 52 00 	movl   $0x5291,0x4(%esp)
    253c:	00 
    253d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2544:	e8 2e 1c 00 00       	call   4177 <printf>
    exit();
    2549:	e8 a1 1a 00 00       	call   3fef <exit>
  }
  if(unlink("dd/ff/ff") == 0){
    254e:	c7 04 24 35 51 00 00 	movl   $0x5135,(%esp)
    2555:	e8 e5 1a 00 00       	call   403f <unlink>
    255a:	85 c0                	test   %eax,%eax
    255c:	75 19                	jne    2577 <subdir+0x611>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    255e:	c7 44 24 04 ad 52 00 	movl   $0x52ad,0x4(%esp)
    2565:	00 
    2566:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    256d:	e8 05 1c 00 00       	call   4177 <printf>
    exit();
    2572:	e8 78 1a 00 00       	call   3fef <exit>
  }
  if(chdir("dd/ff") == 0){
    2577:	c7 04 24 48 4f 00 00 	movl   $0x4f48,(%esp)
    257e:	e8 dc 1a 00 00       	call   405f <chdir>
    2583:	85 c0                	test   %eax,%eax
    2585:	75 19                	jne    25a0 <subdir+0x63a>
    printf(1, "chdir dd/ff succeeded!\n");
    2587:	c7 44 24 04 c9 52 00 	movl   $0x52c9,0x4(%esp)
    258e:	00 
    258f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2596:	e8 dc 1b 00 00       	call   4177 <printf>
    exit();
    259b:	e8 4f 1a 00 00       	call   3fef <exit>
  }
  if(chdir("dd/xx") == 0){
    25a0:	c7 04 24 e1 52 00 00 	movl   $0x52e1,(%esp)
    25a7:	e8 b3 1a 00 00       	call   405f <chdir>
    25ac:	85 c0                	test   %eax,%eax
    25ae:	75 19                	jne    25c9 <subdir+0x663>
    printf(1, "chdir dd/xx succeeded!\n");
    25b0:	c7 44 24 04 e7 52 00 	movl   $0x52e7,0x4(%esp)
    25b7:	00 
    25b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25bf:	e8 b3 1b 00 00       	call   4177 <printf>
    exit();
    25c4:	e8 26 1a 00 00       	call   3fef <exit>
  }

  if(unlink("dd/dd/ffff") != 0){
    25c9:	c7 04 24 10 50 00 00 	movl   $0x5010,(%esp)
    25d0:	e8 6a 1a 00 00       	call   403f <unlink>
    25d5:	85 c0                	test   %eax,%eax
    25d7:	74 19                	je     25f2 <subdir+0x68c>
    printf(1, "unlink dd/dd/ff failed\n");
    25d9:	c7 44 24 04 3d 50 00 	movl   $0x503d,0x4(%esp)
    25e0:	00 
    25e1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25e8:	e8 8a 1b 00 00       	call   4177 <printf>
    exit();
    25ed:	e8 fd 19 00 00       	call   3fef <exit>
  }
  if(unlink("dd/ff") != 0){
    25f2:	c7 04 24 48 4f 00 00 	movl   $0x4f48,(%esp)
    25f9:	e8 41 1a 00 00       	call   403f <unlink>
    25fe:	85 c0                	test   %eax,%eax
    2600:	74 19                	je     261b <subdir+0x6b5>
    printf(1, "unlink dd/ff failed\n");
    2602:	c7 44 24 04 ff 52 00 	movl   $0x52ff,0x4(%esp)
    2609:	00 
    260a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2611:	e8 61 1b 00 00       	call   4177 <printf>
    exit();
    2616:	e8 d4 19 00 00       	call   3fef <exit>
  }
  if(unlink("dd") == 0){
    261b:	c7 04 24 2d 4f 00 00 	movl   $0x4f2d,(%esp)
    2622:	e8 18 1a 00 00       	call   403f <unlink>
    2627:	85 c0                	test   %eax,%eax
    2629:	75 19                	jne    2644 <subdir+0x6de>
    printf(1, "unlink non-empty dd succeeded!\n");
    262b:	c7 44 24 04 14 53 00 	movl   $0x5314,0x4(%esp)
    2632:	00 
    2633:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    263a:	e8 38 1b 00 00       	call   4177 <printf>
    exit();
    263f:	e8 ab 19 00 00       	call   3fef <exit>
  }
  if(unlink("dd/dd") < 0){
    2644:	c7 04 24 34 53 00 00 	movl   $0x5334,(%esp)
    264b:	e8 ef 19 00 00       	call   403f <unlink>
    2650:	85 c0                	test   %eax,%eax
    2652:	79 19                	jns    266d <subdir+0x707>
    printf(1, "unlink dd/dd failed\n");
    2654:	c7 44 24 04 3a 53 00 	movl   $0x533a,0x4(%esp)
    265b:	00 
    265c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2663:	e8 0f 1b 00 00       	call   4177 <printf>
    exit();
    2668:	e8 82 19 00 00       	call   3fef <exit>
  }
  if(unlink("dd") < 0){
    266d:	c7 04 24 2d 4f 00 00 	movl   $0x4f2d,(%esp)
    2674:	e8 c6 19 00 00       	call   403f <unlink>
    2679:	85 c0                	test   %eax,%eax
    267b:	79 19                	jns    2696 <subdir+0x730>
    printf(1, "unlink dd failed\n");
    267d:	c7 44 24 04 4f 53 00 	movl   $0x534f,0x4(%esp)
    2684:	00 
    2685:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    268c:	e8 e6 1a 00 00       	call   4177 <printf>
    exit();
    2691:	e8 59 19 00 00       	call   3fef <exit>
  }

  printf(1, "subdir ok\n");
    2696:	c7 44 24 04 61 53 00 	movl   $0x5361,0x4(%esp)
    269d:	00 
    269e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26a5:	e8 cd 1a 00 00       	call   4177 <printf>
}
    26aa:	c9                   	leave  
    26ab:	c3                   	ret    
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 6c 53 00 	movl   $0x536c,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 b1 1a 00 00       	call   4177 <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 7b 53 00 00 	movl   $0x537b,(%esp)
    26cd:	e8 6d 19 00 00       	call   403f <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 7b 53 00 00 	movl   $0x537b,(%esp)
    26ed:	e8 3d 19 00 00       	call   402f <open>
    26f2:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(fd < 0){
    26f5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    26f9:	79 19                	jns    2714 <bigwrite+0x68>
      printf(1, "cannot create bigwrite\n");
    26fb:	c7 44 24 04 84 53 00 	movl   $0x5384,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 68 1a 00 00       	call   4177 <printf>
      exit();
    270f:	e8 db 18 00 00       	call   3fef <exit>
    }
    int i;
    for(i = 0; i < 2; i++){
    ...
    2732:	e8 d8 18 00 00       	call   400f <write>
    ...
    2750:	c7 44 24 04 9c 53 00 	movl   $0x539c,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 13 1a 00 00       	call   4177 <printf>
        exit();
    2764:	e8 86 18 00 00       	call   3fef <exit>
    for(i = 0; i < 2; i++){
    ...
    2779:	e8 99 18 00 00       	call   4017 <close>
    unlink("bigwrite");
    277e:	c7 04 24 7b 53 00 00 	movl   $0x537b,(%esp)
    2785:	e8 b5 18 00 00       	call   403f <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 ae 53 00 	movl   $0x53ae,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 c5 19 00 00       	call   4177 <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 bb 53 00 	movl   $0x53bb,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 a9 19 00 00       	call   4177 <printf>

  unlink("bigfile");
    27ce:	c7 04 24 c9 53 00 00 	movl   $0x53c9,(%esp)
    27d5:	e8 65 18 00 00       	call   403f <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 c9 53 00 00 	movl   $0x53c9,(%esp)
    27e9:	e8 41 18 00 00       	call   402f <open>
    27ee:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    27f1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    27f5:	79 19                	jns    2810 <bigfile+0x5c>
    printf(1, "cannot create bigfile");
    27f7:	c7 44 24 04 d1 53 00 	movl   $0x53d1,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 6c 19 00 00       	call   4177 <printf>
    exit();
    280b:	e8 df 17 00 00       	call   3fef <exit>
  }
  for(i = 0; i < 20; i++){
    ...
    282f:	e8 0e 16 00 00       	call   3e42 <memset>
    ...
    284a:	e8 c0 17 00 00       	call   400f <write>
    284f:	3d 58 02 00 00       	cmp    $0x258,%eax
    2854:	74 19                	je     286f <bigfile+0xbb>
      printf(1, "write bigfile failed\n");
    2856:	c7 44 24 04 e7 53 00 	movl   $0x53e7,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 0d 19 00 00       	call   4177 <printf>
      exit();
    286a:	e8 80 17 00 00       	call   3fef <exit>
  for(i = 0; i < 20; i++){
  ...
  close(fd);
    ...
    287f:	e8 93 17 00 00       	call   4017 <close>

  fd = open("bigfile", 0);
    2884:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    288b:	00 
    288c:	c7 04 24 c9 53 00 00 	movl   $0x53c9,(%esp)
    2893:	e8 97 17 00 00       	call   402f <open>
    2898:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    289b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    289f:	79 19                	jns    28ba <bigfile+0x106>
    printf(1, "cannot open bigfile\n");
    28a1:	c7 44 24 04 fd 53 00 	movl   $0x53fd,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 c2 18 00 00       	call   4177 <printf>
    exit();
    28b5:	e8 35 17 00 00       	call   3fef <exit>
  }
  total = 0;
  ...
  for(i = 0; ; i++){
    ...
    28de:	e8 24 17 00 00       	call   4007 <read>
    28e3:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(cc < 0){
    28e6:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
    28ea:	79 19                	jns    2905 <bigfile+0x151>
      printf(1, "read bigfile failed\n");
    28ec:	c7 44 24 04 12 54 00 	movl   $0x5412,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 77 18 00 00       	call   4177 <printf>
      exit();
    2900:	e8 ea 16 00 00       	call   3fef <exit>
    }
    if(cc == 0)
  ...
  close(fd);
    ...
    2912:	e8 00 17 00 00       	call   4017 <close>
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 27 54 00 	movl   $0x5427,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 34 18 00 00       	call   4177 <printf>
      exit();
    2943:	e8 a7 16 00 00       	call   3fef <exit>
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 3b 54 00 	movl   $0x543b,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 e7 17 00 00       	call   4177 <printf>
      exit();
    2990:	e8 5a 16 00 00       	call   3fef <exit>
    total += cc;
  ...
  for(i = 0; ; i++){
    ...
    29a4:	c7 44 24 04 54 54 00 	movl   $0x5454,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 bf 17 00 00       	call   4177 <printf>
    exit();
    29b8:	e8 32 16 00 00       	call   3fef <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 c9 53 00 00 	movl   $0x53c9,(%esp)
    29c4:	e8 76 16 00 00       	call   403f <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 6e 54 00 	movl   $0x546e,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 9a 17 00 00       	call   4177 <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    29e5:	c7 44 24 04 7f 54 00 	movl   $0x547f,0x4(%esp)
    29ec:	00 
    29ed:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29f4:	e8 7e 17 00 00       	call   4177 <printf>

  if(mkdir("12345678901234") != 0){
    29f9:	c7 04 24 8e 54 00 00 	movl   $0x548e,(%esp)
    2a00:	e8 52 16 00 00       	call   4057 <mkdir>
    2a05:	85 c0                	test   %eax,%eax
    2a07:	74 19                	je     2a22 <fourteen+0x43>
    printf(1, "mkdir 12345678901234 failed\n");
    2a09:	c7 44 24 04 9d 54 00 	movl   $0x549d,0x4(%esp)
    2a10:	00 
    2a11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a18:	e8 5a 17 00 00       	call   4177 <printf>
    exit();
    2a1d:	e8 cd 15 00 00       	call   3fef <exit>
  }
  if(mkdir("12345678901234/123456789012345") != 0){
    2a22:	c7 04 24 bc 54 00 00 	movl   $0x54bc,(%esp)
    2a29:	e8 29 16 00 00       	call   4057 <mkdir>
    2a2e:	85 c0                	test   %eax,%eax
    2a30:	74 19                	je     2a4b <fourteen+0x6c>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    2a32:	c7 44 24 04 dc 54 00 	movl   $0x54dc,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a41:	e8 31 17 00 00       	call   4177 <printf>
    exit();
    2a46:	e8 a4 15 00 00       	call   3fef <exit>
  }
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    2a4b:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a52:	00 
    2a53:	c7 04 24 0c 55 00 00 	movl   $0x550c,(%esp)
    2a5a:	e8 d0 15 00 00       	call   402f <open>
    2a5f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2a62:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2a66:	79 19                	jns    2a81 <fourteen+0xa2>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    2a68:	c7 44 24 04 3c 55 00 	movl   $0x553c,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 fb 16 00 00       	call   4177 <printf>
    exit();
    2a7c:	e8 6e 15 00 00       	call   3fef <exit>
  }
  close(fd);
    2a81:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2a84:	89 04 24             	mov    %eax,(%esp)
    2a87:	e8 8b 15 00 00       	call   4017 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2a8c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2a93:	00 
    2a94:	c7 04 24 7c 55 00 00 	movl   $0x557c,(%esp)
    2a9b:	e8 8f 15 00 00       	call   402f <open>
    2aa0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2aa3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2aa7:	79 19                	jns    2ac2 <fourteen+0xe3>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2aa9:	c7 44 24 04 ac 55 00 	movl   $0x55ac,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 ba 16 00 00       	call   4177 <printf>
    exit();
    2abd:	e8 2d 15 00 00       	call   3fef <exit>
  }
  close(fd);
    2ac2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ac5:	89 04 24             	mov    %eax,(%esp)
    2ac8:	e8 4a 15 00 00       	call   4017 <close>

  if(mkdir("12345678901234/12345678901234") == 0){
    2acd:	c7 04 24 e6 55 00 00 	movl   $0x55e6,(%esp)
    2ad4:	e8 7e 15 00 00       	call   4057 <mkdir>
    2ad9:	85 c0                	test   %eax,%eax
    2adb:	75 19                	jne    2af6 <fourteen+0x117>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2add:	c7 44 24 04 04 56 00 	movl   $0x5604,0x4(%esp)
    2ae4:	00 
    2ae5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2aec:	e8 86 16 00 00       	call   4177 <printf>
    exit();
    2af1:	e8 f9 14 00 00       	call   3fef <exit>
  }
  if(mkdir("123456789012345/12345678901234") == 0){
    2af6:	c7 04 24 34 56 00 00 	movl   $0x5634,(%esp)
    2afd:	e8 55 15 00 00       	call   4057 <mkdir>
    2b02:	85 c0                	test   %eax,%eax
    2b04:	75 19                	jne    2b1f <fourteen+0x140>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2b06:	c7 44 24 04 54 56 00 	movl   $0x5654,0x4(%esp)
    2b0d:	00 
    2b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b15:	e8 5d 16 00 00       	call   4177 <printf>
    exit();
    2b1a:	e8 d0 14 00 00       	call   3fef <exit>
  }

  printf(1, "fourteen ok\n");
    2b1f:	c7 44 24 04 85 56 00 	movl   $0x5685,0x4(%esp)
    2b26:	00 
    2b27:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b2e:	e8 44 16 00 00       	call   4177 <printf>
}
    2b33:	c9                   	leave  
    2b34:	c3                   	ret    
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    2b3b:	c7 44 24 04 92 56 00 	movl   $0x5692,0x4(%esp)
    2b42:	00 
    2b43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b4a:	e8 28 16 00 00       	call   4177 <printf>
  if(mkdir("dots") != 0){
    2b4f:	c7 04 24 9e 56 00 00 	movl   $0x569e,(%esp)
    2b56:	e8 fc 14 00 00       	call   4057 <mkdir>
    2b5b:	85 c0                	test   %eax,%eax
    2b5d:	74 19                	je     2b78 <rmdot+0x43>
    printf(1, "mkdir dots failed\n");
    2b5f:	c7 44 24 04 a3 56 00 	movl   $0x56a3,0x4(%esp)
    2b66:	00 
    2b67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b6e:	e8 04 16 00 00       	call   4177 <printf>
    exit();
    2b73:	e8 77 14 00 00       	call   3fef <exit>
  }
  if(chdir("dots") != 0){
    2b78:	c7 04 24 9e 56 00 00 	movl   $0x569e,(%esp)
    2b7f:	e8 db 14 00 00       	call   405f <chdir>
    2b84:	85 c0                	test   %eax,%eax
    2b86:	74 19                	je     2ba1 <rmdot+0x6c>
    printf(1, "chdir dots failed\n");
    2b88:	c7 44 24 04 b6 56 00 	movl   $0x56b6,0x4(%esp)
    2b8f:	00 
    2b90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b97:	e8 db 15 00 00       	call   4177 <printf>
    exit();
    2b9c:	e8 4e 14 00 00       	call   3fef <exit>
  }
  if(unlink(".") == 0){
    2ba1:	c7 04 24 cf 4d 00 00 	movl   $0x4dcf,(%esp)
    2ba8:	e8 92 14 00 00       	call   403f <unlink>
    2bad:	85 c0                	test   %eax,%eax
    2baf:	75 19                	jne    2bca <rmdot+0x95>
    printf(1, "rm . worked!\n");
    2bb1:	c7 44 24 04 c9 56 00 	movl   $0x56c9,0x4(%esp)
    2bb8:	00 
    2bb9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2bc0:	e8 b2 15 00 00       	call   4177 <printf>
    exit();
    2bc5:	e8 25 14 00 00       	call   3fef <exit>
  }
  if(unlink("..") == 0){
    2bca:	c7 04 24 62 49 00 00 	movl   $0x4962,(%esp)
    2bd1:	e8 69 14 00 00       	call   403f <unlink>
    2bd6:	85 c0                	test   %eax,%eax
    2bd8:	75 19                	jne    2bf3 <rmdot+0xbe>
    printf(1, "rm .. worked!\n");
    2bda:	c7 44 24 04 d7 56 00 	movl   $0x56d7,0x4(%esp)
    2be1:	00 
    2be2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be9:	e8 89 15 00 00       	call   4177 <printf>
    exit();
    2bee:	e8 fc 13 00 00       	call   3fef <exit>
  }
  if(chdir("/") != 0){
    2bf3:	c7 04 24 b6 45 00 00 	movl   $0x45b6,(%esp)
    2bfa:	e8 60 14 00 00       	call   405f <chdir>
    2bff:	85 c0                	test   %eax,%eax
    2c01:	74 19                	je     2c1c <rmdot+0xe7>
    printf(1, "chdir / failed\n");
    2c03:	c7 44 24 04 b8 45 00 	movl   $0x45b8,0x4(%esp)
    2c0a:	00 
    2c0b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c12:	e8 60 15 00 00       	call   4177 <printf>
    exit();
    2c17:	e8 d3 13 00 00       	call   3fef <exit>
  }
  if(unlink("dots/.") == 0){
    2c1c:	c7 04 24 e6 56 00 00 	movl   $0x56e6,(%esp)
    2c23:	e8 17 14 00 00       	call   403f <unlink>
    2c28:	85 c0                	test   %eax,%eax
    2c2a:	75 19                	jne    2c45 <rmdot+0x110>
    printf(1, "unlink dots/. worked!\n");
    2c2c:	c7 44 24 04 ed 56 00 	movl   $0x56ed,0x4(%esp)
    2c33:	00 
    2c34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c3b:	e8 37 15 00 00       	call   4177 <printf>
    exit();
    2c40:	e8 aa 13 00 00       	call   3fef <exit>
  }
  if(unlink("dots/..") == 0){
    2c45:	c7 04 24 04 57 00 00 	movl   $0x5704,(%esp)
    2c4c:	e8 ee 13 00 00       	call   403f <unlink>
    2c51:	85 c0                	test   %eax,%eax
    2c53:	75 19                	jne    2c6e <rmdot+0x139>
    printf(1, "unlink dots/.. worked!\n");
    2c55:	c7 44 24 04 0c 57 00 	movl   $0x570c,0x4(%esp)
    2c5c:	00 
    2c5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c64:	e8 0e 15 00 00       	call   4177 <printf>
    exit();
    2c69:	e8 81 13 00 00       	call   3fef <exit>
  }
  if(unlink("dots") != 0){
    2c6e:	c7 04 24 9e 56 00 00 	movl   $0x569e,(%esp)
    2c75:	e8 c5 13 00 00       	call   403f <unlink>
    2c7a:	85 c0                	test   %eax,%eax
    2c7c:	74 19                	je     2c97 <rmdot+0x162>
    printf(1, "unlink dots failed!\n");
    2c7e:	c7 44 24 04 24 57 00 	movl   $0x5724,0x4(%esp)
    2c85:	00 
    2c86:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c8d:	e8 e5 14 00 00       	call   4177 <printf>
    exit();
    2c92:	e8 58 13 00 00       	call   3fef <exit>
  }
  printf(1, "rmdot ok\n");
    2c97:	c7 44 24 04 39 57 00 	movl   $0x5739,0x4(%esp)
    2c9e:	00 
    2c9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ca6:	e8 cc 14 00 00       	call   4177 <printf>
}
    2cab:	c9                   	leave  
    2cac:	c3                   	ret    
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 43 57 00 	movl   $0x5743,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 b0 14 00 00       	call   4177 <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 50 57 00 00 	movl   $0x5750,(%esp)
    2cd6:	e8 54 13 00 00       	call   402f <open>
    2cdb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2cde:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2ce2:	79 19                	jns    2cfd <dirfile+0x50>
    printf(1, "create dirfile failed\n");
    2ce4:	c7 44 24 04 58 57 00 	movl   $0x5758,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 7f 14 00 00       	call   4177 <printf>
    exit();
    2cf8:	e8 f2 12 00 00       	call   3fef <exit>
  }
  close(fd);
    2cfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2d00:	89 04 24             	mov    %eax,(%esp)
    2d03:	e8 0f 13 00 00       	call   4017 <close>
  if(chdir("dirfile") == 0){
    2d08:	c7 04 24 50 57 00 00 	movl   $0x5750,(%esp)
    2d0f:	e8 4b 13 00 00       	call   405f <chdir>
    2d14:	85 c0                	test   %eax,%eax
    2d16:	75 19                	jne    2d31 <dirfile+0x84>
    printf(1, "chdir dirfile succeeded!\n");
    2d18:	c7 44 24 04 6f 57 00 	movl   $0x576f,0x4(%esp)
    2d1f:	00 
    2d20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d27:	e8 4b 14 00 00       	call   4177 <printf>
    exit();
    2d2c:	e8 be 12 00 00       	call   3fef <exit>
  }
  fd = open("dirfile/xx", 0);
    2d31:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2d38:	00 
    2d39:	c7 04 24 89 57 00 00 	movl   $0x5789,(%esp)
    2d40:	e8 ea 12 00 00       	call   402f <open>
    2d45:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2d48:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2d4c:	78 19                	js     2d67 <dirfile+0xba>
    printf(1, "create dirfile/xx succeeded!\n");
    2d4e:	c7 44 24 04 94 57 00 	movl   $0x5794,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 15 14 00 00       	call   4177 <printf>
    exit();
    2d62:	e8 88 12 00 00       	call   3fef <exit>
  }
  fd = open("dirfile/xx", O_CREATE);
    2d67:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2d6e:	00 
    2d6f:	c7 04 24 89 57 00 00 	movl   $0x5789,(%esp)
    2d76:	e8 b4 12 00 00       	call   402f <open>
    2d7b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2d7e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2d82:	78 19                	js     2d9d <dirfile+0xf0>
    printf(1, "create dirfile/xx succeeded!\n");
    2d84:	c7 44 24 04 94 57 00 	movl   $0x5794,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 df 13 00 00       	call   4177 <printf>
    exit();
    2d98:	e8 52 12 00 00       	call   3fef <exit>
  }
  if(mkdir("dirfile/xx") == 0){
    2d9d:	c7 04 24 89 57 00 00 	movl   $0x5789,(%esp)
    2da4:	e8 ae 12 00 00       	call   4057 <mkdir>
    2da9:	85 c0                	test   %eax,%eax
    2dab:	75 19                	jne    2dc6 <dirfile+0x119>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2dad:	c7 44 24 04 b2 57 00 	movl   $0x57b2,0x4(%esp)
    2db4:	00 
    2db5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbc:	e8 b6 13 00 00       	call   4177 <printf>
    exit();
    2dc1:	e8 29 12 00 00       	call   3fef <exit>
  }
  if(unlink("dirfile/xx") == 0){
    2dc6:	c7 04 24 89 57 00 00 	movl   $0x5789,(%esp)
    2dcd:	e8 6d 12 00 00       	call   403f <unlink>
    2dd2:	85 c0                	test   %eax,%eax
    2dd4:	75 19                	jne    2def <dirfile+0x142>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2dd6:	c7 44 24 04 cf 57 00 	movl   $0x57cf,0x4(%esp)
    2ddd:	00 
    2dde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de5:	e8 8d 13 00 00       	call   4177 <printf>
    exit();
    2dea:	e8 00 12 00 00       	call   3fef <exit>
  }
  if(link("README", "dirfile/xx") == 0){
    2def:	c7 44 24 04 89 57 00 	movl   $0x5789,0x4(%esp)
    2df6:	00 
    2df7:	c7 04 24 ed 57 00 00 	movl   $0x57ed,(%esp)
    2dfe:	e8 4c 12 00 00       	call   404f <link>
    2e03:	85 c0                	test   %eax,%eax
    2e05:	75 19                	jne    2e20 <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2e07:	c7 44 24 04 f4 57 00 	movl   $0x57f4,0x4(%esp)
    2e0e:	00 
    2e0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e16:	e8 5c 13 00 00       	call   4177 <printf>
    exit();
    2e1b:	e8 cf 11 00 00       	call   3fef <exit>
  }
  if(unlink("dirfile") != 0){
    2e20:	c7 04 24 50 57 00 00 	movl   $0x5750,(%esp)
    2e27:	e8 13 12 00 00       	call   403f <unlink>
    2e2c:	85 c0                	test   %eax,%eax
    2e2e:	74 19                	je     2e49 <dirfile+0x19c>
    printf(1, "unlink dirfile failed!\n");
    2e30:	c7 44 24 04 13 58 00 	movl   $0x5813,0x4(%esp)
    2e37:	00 
    2e38:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e3f:	e8 33 13 00 00       	call   4177 <printf>
    exit();
    2e44:	e8 a6 11 00 00       	call   3fef <exit>
  }

  fd = open(".", O_RDWR);
    2e49:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
    2e50:	00 
    2e51:	c7 04 24 cf 4d 00 00 	movl   $0x4dcf,(%esp)
    2e58:	e8 d2 11 00 00       	call   402f <open>
    2e5d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2e60:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2e64:	78 19                	js     2e7f <dirfile+0x1d2>
    printf(1, "open . for writing succeeded!\n");
    2e66:	c7 44 24 04 2c 58 00 	movl   $0x582c,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 fd 12 00 00       	call   4177 <printf>
    exit();
    2e7a:	e8 70 11 00 00       	call   3fef <exit>
  }
  fd = open(".", 0);
    2e7f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2e86:	00 
    2e87:	c7 04 24 cf 4d 00 00 	movl   $0x4dcf,(%esp)
    2e8e:	e8 9c 11 00 00       	call   402f <open>
    2e93:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(write(fd, "x", 1) > 0){
    2e96:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2e9d:	00 
    2e9e:	c7 44 24 04 1b 4a 00 	movl   $0x4a1b,0x4(%esp)
    2ea5:	00 
    2ea6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ea9:	89 04 24             	mov    %eax,(%esp)
    2eac:	e8 5e 11 00 00       	call   400f <write>
    2eb1:	85 c0                	test   %eax,%eax
    2eb3:	7e 19                	jle    2ece <dirfile+0x221>
    printf(1, "write . succeeded!\n");
    2eb5:	c7 44 24 04 4b 58 00 	movl   $0x584b,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 ae 12 00 00       	call   4177 <printf>
    exit();
    2ec9:	e8 21 11 00 00       	call   3fef <exit>
  }
  close(fd);
    2ece:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2ed1:	89 04 24             	mov    %eax,(%esp)
    2ed4:	e8 3e 11 00 00       	call   4017 <close>

  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 5f 58 00 	movl   $0x585f,0x4(%esp)
    2ee0:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 6f 58 00 	movl   $0x586f,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 6e 12 00 00       	call   4177 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    if(mkdir("irefd") != 0){
    2f15:	c7 04 24 80 58 00 00 	movl   $0x5880,(%esp)
    2f1c:	e8 36 11 00 00       	call   4057 <mkdir>
    2f21:	85 c0                	test   %eax,%eax
    2f23:	74 19                	je     2f3e <iref+0x4f>
      printf(1, "mkdir irefd failed\n");
    2f25:	c7 44 24 04 86 58 00 	movl   $0x5886,0x4(%esp)
    2f2c:	00 
    2f2d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f34:	e8 3e 12 00 00       	call   4177 <printf>
      exit();
    2f39:	e8 b1 10 00 00       	call   3fef <exit>
    }
    if(chdir("irefd") != 0){
    2f3e:	c7 04 24 80 58 00 00 	movl   $0x5880,(%esp)
    2f45:	e8 15 11 00 00       	call   405f <chdir>
    2f4a:	85 c0                	test   %eax,%eax
    2f4c:	74 19                	je     2f67 <iref+0x78>
      printf(1, "chdir irefd failed\n");
    2f4e:	c7 44 24 04 9a 58 00 	movl   $0x589a,0x4(%esp)
    2f55:	00 
    2f56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f5d:	e8 15 12 00 00       	call   4177 <printf>
      exit();
    2f62:	e8 88 10 00 00       	call   3fef <exit>
    }

    mkdir("");
    2f67:	c7 04 24 ae 58 00 00 	movl   $0x58ae,(%esp)
    2f6e:	e8 e4 10 00 00       	call   4057 <mkdir>
    link("README", "");
    2f73:	c7 44 24 04 ae 58 00 	movl   $0x58ae,0x4(%esp)
    2f7a:	00 
    2f7b:	c7 04 24 ed 57 00 00 	movl   $0x57ed,(%esp)
    2f82:	e8 c8 10 00 00       	call   404f <link>
    fd = open("", O_CREATE);
    2f87:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2f8e:	00 
    2f8f:	c7 04 24 ae 58 00 00 	movl   $0x58ae,(%esp)
    2f96:	e8 94 10 00 00       	call   402f <open>
    ...
    2faa:	e8 68 10 00 00       	call   4017 <close>
    fd = open("xx", O_CREATE);
    2faf:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2fb6:	00 
    2fb7:	c7 04 24 af 58 00 00 	movl   $0x58af,(%esp)
    2fbe:	e8 6c 10 00 00       	call   402f <open>
    ...
    2fd2:	e8 40 10 00 00       	call   4017 <close>
    unlink("xx");
    2fd7:	c7 04 24 af 58 00 00 	movl   $0x58af,(%esp)
    2fde:	e8 5c 10 00 00       	call   403f <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    2ff1:	c7 04 24 b6 45 00 00 	movl   $0x45b6,(%esp)
    2ff8:	e8 62 10 00 00       	call   405f <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 b2 58 00 	movl   $0x58b2,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 66 11 00 00       	call   4177 <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 c6 58 00 	movl   $0x58c6,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 4a 11 00 00       	call   4177 <printf>

  for(n=0; n<1000; n++){
    302d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3034:	eb 1f                	jmp    3055 <forktest+0x42>
    pid = fork();
    3036:	e8 ac 0f 00 00       	call   3fe7 <fork>
    ...
    304a:	75 05                	jne    3051 <forktest+0x3e>
      exit();
    304c:	e8 9e 0f 00 00       	call   3fef <exit>
  for(n=0; n<1000; n++){
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 d4 58 00 	movl   $0x58d4,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 fc 10 00 00       	call   4177 <printf>
    exit();
    307b:	e8 6f 0f 00 00       	call   3fef <exit>
  }

  for(; n > 0; n--){
    3080:	eb 26                	jmp    30a8 <forktest+0x95>
    if(wait() < 0){
    3082:	e8 70 0f 00 00       	call   3ff7 <wait>
    3087:	85 c0                	test   %eax,%eax
    3089:	79 19                	jns    30a4 <forktest+0x91>
      printf(1, "wait stopped early\n");
    308b:	c7 44 24 04 f6 58 00 	movl   $0x58f6,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 d8 10 00 00       	call   4177 <printf>
      exit();
    309f:	e8 4b 0f 00 00       	call   3fef <exit>
  for(; n > 0; n--){
  ...
  if(wait() != -1){
    30ae:	e8 44 0f 00 00       	call   3ff7 <wait>
    30b3:	83 f8 ff             	cmp    $0xffffffff,%eax
    30b6:	74 19                	je     30d1 <forktest+0xbe>
    printf(1, "wait got too many\n");
    30b8:	c7 44 24 04 0a 59 00 	movl   $0x590a,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 ab 10 00 00       	call   4177 <printf>
    exit();
    30cc:	e8 1e 0f 00 00       	call   3fef <exit>
  }

  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 1d 59 00 	movl   $0x591d,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 92 10 00 00       	call   4177 <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 c4 64 00 00       	mov    0x64c4,%eax
    30f6:	c7 44 24 04 2b 59 00 	movl   $0x592b,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 71 10 00 00       	call   4177 <printf>
  oldbrk = sbrk(0);
    3106:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    310d:	e8 65 0f 00 00       	call   4077 <sbrk>
    3112:	89 45 ec             	mov    %eax,-0x14(%ebp)

  // can one sbrk() less than a page?
  a = sbrk(0);
    3115:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    311c:	e8 56 0f 00 00       	call   4077 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    3134:	e8 3e 0f 00 00       	call   4077 <sbrk>
    ...
    3144:	a1 c4 64 00 00       	mov    0x64c4,%eax
    ...
    315e:	c7 44 24 04 36 59 00 	movl   $0x5936,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 09 10 00 00       	call   4177 <printf>
      exit();
    316e:	e8 7c 0e 00 00       	call   3fef <exit>
    }
    *b = 1;
  ...
  pid = fork();
    318f:	e8 53 0e 00 00       	call   3fe7 <fork>
    3194:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(pid < 0){
    3197:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    319b:	79 1a                	jns    31b7 <sbrktest+0xd0>
    printf(stdout, "sbrk test fork failed\n");
    319d:	a1 c4 64 00 00       	mov    0x64c4,%eax
    31a2:	c7 44 24 04 51 59 00 	movl   $0x5951,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 c5 0f 00 00       	call   4177 <printf>
    exit();
    31b2:	e8 38 0e 00 00       	call   3fef <exit>
  }
  c = sbrk(1);
    31b7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31be:	e8 b4 0e 00 00       	call   4077 <sbrk>
    31c3:	89 45 e0             	mov    %eax,-0x20(%ebp)
  c = sbrk(1);
    31c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31cd:	e8 a5 0e 00 00       	call   4077 <sbrk>
  ...
  if(c != a + 1){
    ...
    31e0:	a1 c4 64 00 00       	mov    0x64c4,%eax
    31e5:	c7 44 24 04 68 59 00 	movl   $0x5968,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 82 0f 00 00       	call   4177 <printf>
    exit();
    31f5:	e8 f5 0d 00 00       	call   3fef <exit>
  }
  if(pid == 0)
    31fa:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    31fe:	75 05                	jne    3205 <sbrktest+0x11e>
    exit();
    3200:	e8 ea 0d 00 00       	call   3fef <exit>
  wait();
    3205:	e8 ed 0d 00 00       	call   3ff7 <wait>

  // can one grow address space to something big?
#define BIG (100*1024*1024)
  a = sbrk(0);
    320a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3211:	e8 61 0e 00 00       	call   4077 <sbrk>
  ...
  p = sbrk(amt);
    ...
    322e:	e8 44 0e 00 00       	call   4077 <sbrk>
  ...
  if (p != a) {
    ...
    323e:	a1 c4 64 00 00       	mov    0x64c4,%eax
    3243:	c7 44 24 04 84 59 00 	movl   $0x5984,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 24 0f 00 00       	call   4177 <printf>
    exit();
    3253:	e8 97 0d 00 00       	call   3fef <exit>
  }
  lastaddr = (char*) (BIG-1);
  ...
  *lastaddr = 99;
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 c4 64 00 00       	mov    0x64c4,%eax
    ...
    32d2:	c7 44 24 04 e0 59 00 	movl   $0x59e0,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 95 0e 00 00       	call   4177 <printf>
    exit();
    32e2:	e8 08 0d 00 00       	call   3fef <exit>
  }

  // can one re-allocate that page?
  a = sbrk(0);
    32e7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    32ee:	e8 84 0d 00 00       	call   4077 <sbrk>
    32f3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c = sbrk(4096);
    32f6:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    32fd:	e8 75 0d 00 00       	call   4077 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3314:	e8 5e 0d 00 00       	call   4077 <sbrk>
    ...
    3326:	a1 c4 64 00 00       	mov    0x64c4,%eax
    ...
    3339:	c7 44 24 04 18 5a 00 	movl   $0x5a18,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 2e 0e 00 00       	call   4177 <printf>
    exit();
    3349:	e8 a1 0c 00 00       	call   3fef <exit>
  }
  if(*lastaddr == 99){
    ...
    3358:	a1 c4 64 00 00       	mov    0x64c4,%eax
    335d:	c7 44 24 04 40 5a 00 	movl   $0x5a40,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 0a 0e 00 00       	call   4177 <printf>
    exit();
    336d:	e8 7d 0c 00 00       	call   3fef <exit>
  }

  a = sbrk(0);
    3372:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3379:	e8 f9 0c 00 00       	call   4077 <sbrk>
    337e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c = sbrk(-(sbrk(0) - oldbrk));
    3381:	8b 5d ec             	mov    -0x14(%ebp),%ebx
    3384:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    338b:	e8 e7 0c 00 00       	call   4077 <sbrk>
    3390:	29 c3                	sub    %eax,%ebx
    3392:	89 d8                	mov    %ebx,%eax
    3394:	89 04 24             	mov    %eax,(%esp)
    3397:	e8 db 0c 00 00       	call   4077 <sbrk>
  ...
  if(c != a){
    ...
    33a7:	a1 c4 64 00 00       	mov    0x64c4,%eax
    ...
    33ba:	c7 44 24 04 70 5a 00 	movl   $0x5a70,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 ad 0d 00 00       	call   4177 <printf>
    exit();
    33ca:	e8 20 0c 00 00       	call   3fef <exit>
  }
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    33d8:	e8 92 0c 00 00       	call   406f <getpid>
    33dd:	89 45 d0             	mov    %eax,-0x30(%ebp)
    pid = fork();
    33e0:	e8 02 0c 00 00       	call   3fe7 <fork>
    33e5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(pid < 0){
    33e8:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 c4 64 00 00       	mov    0x64c4,%eax
    33f3:	c7 44 24 04 e5 45 00 	movl   $0x45e5,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 74 0d 00 00       	call   4177 <printf>
      exit();
    3403:	e8 e7 0b 00 00       	call   3fef <exit>
    }
    if(pid == 0){
    ...
    3417:	a1 c4 64 00 00       	mov    0x64c4,%eax
    341c:	89 54 24 0c          	mov    %edx,0xc(%esp)
    3420:	8b 55 f4             	mov    -0xc(%ebp),%edx
    3423:	89 54 24 08          	mov    %edx,0x8(%esp)
    3427:	c7 44 24 04 91 5a 00 	movl   $0x5a91,0x4(%esp)
    342e:	00 
    342f:	89 04 24             	mov    %eax,(%esp)
    3432:	e8 40 0d 00 00       	call   4177 <printf>
      kill(ppid);
    3437:	8b 45 d0             	mov    -0x30(%ebp),%eax
    343a:	89 04 24             	mov    %eax,(%esp)
    343d:	e8 dd 0b 00 00       	call   401f <kill>
      exit();
    3442:	e8 a8 0b 00 00       	call   3fef <exit>
    }
    wait();
    3447:	e8 ab 0b 00 00       	call   3ff7 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3512:	e8 f0 0a 00 00       	call   4007 <read>
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
  ...
  c = sbrk(4096);
    ...
    352e:	e8 44 0b 00 00       	call   4077 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3557:	e8 c3 0a 00 00       	call   401f <kill>
    wait();
    355c:	e8 96 0a 00 00       	call   3ff7 <wait>
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 c4 64 00 00       	mov    0x64c4,%eax
    3578:	c7 44 24 04 aa 5a 00 	movl   $0x5aaa,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 ef 0b 00 00       	call   4177 <printf>
    exit();
    3588:	e8 62 0a 00 00       	call   3fef <exit>
  }

  if(sbrk(0) > oldbrk)
    358d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3594:	e8 de 0a 00 00       	call   4077 <sbrk>
    ...
    35a8:	e8 ca 0a 00 00       	call   4077 <sbrk>
    35ad:	29 c3                	sub    %eax,%ebx
    35af:	89 d8                	mov    %ebx,%eax
    35b1:	89 04 24             	mov    %eax,(%esp)
    35b4:	e8 be 0a 00 00       	call   4077 <sbrk>

  printf(stdout, "sbrk test OK\n");
    35b9:	a1 c4 64 00 00       	mov    0x64c4,%eax
    35be:	c7 44 24 04 c5 5a 00 	movl   $0x5ac5,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 a9 0b 00 00       	call   4177 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 c4 64 00 00       	mov    0x64c4,%eax
    3604:	c7 44 24 04 d3 5a 00 	movl   $0x5ad3,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 63 0b 00 00       	call   4177 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    if((pid = fork()) == 0){
    3624:	e8 be 09 00 00       	call   3fe7 <fork>
    ...
    3638:	e8 9a ff ff ff       	call   35d7 <validateint>
      exit();
    363d:	e8 ad 09 00 00       	call   3fef <exit>
    }
    sleep(0);
    3642:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3649:	e8 31 0a 00 00       	call   407f <sleep>
    sleep(0);
    364e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3655:	e8 25 0a 00 00       	call   407f <sleep>
    kill(pid);
    365a:	8b 45 ec             	mov    -0x14(%ebp),%eax
    365d:	89 04 24             	mov    %eax,(%esp)
    3660:	e8 ba 09 00 00       	call   401f <kill>
    wait();
    3665:	e8 8d 09 00 00       	call   3ff7 <wait>

    // try to crash the kernel by passing in a bad string pointer
    if(link("nosuchfile", (char*)p) != -1){
    366a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    366d:	89 44 24 04          	mov    %eax,0x4(%esp)
    3671:	c7 04 24 e2 5a 00 00 	movl   $0x5ae2,(%esp)
    3678:	e8 d2 09 00 00       	call   404f <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 c4 64 00 00       	mov    0x64c4,%eax
    3687:	c7 44 24 04 ed 5a 00 	movl   $0x5aed,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 e0 0a 00 00       	call   4177 <printf>
      exit();
    3697:	e8 53 09 00 00       	call   3fef <exit>
  for(p = 0; p <= (uint)hi; p += 4096){
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 c4 64 00 00       	mov    0x64c4,%eax
    36b4:	c7 44 24 04 06 5b 00 	movl   $0x5b06,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 b3 0a 00 00       	call   4177 <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36cc:	a1 c4 64 00 00       	mov    0x64c4,%eax
    36d1:	c7 44 24 04 13 5b 00 	movl   $0x5b13,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 96 0a 00 00       	call   4177 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    36f9:	a1 c4 64 00 00       	mov    0x64c4,%eax
    36fe:	c7 44 24 04 1d 5b 00 	movl   $0x5b1d,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 69 0a 00 00       	call   4177 <printf>
      exit();
    370e:	e8 dc 08 00 00       	call   3fef <exit>
  for(i = 0; i < sizeof(uninit); i++){
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 c4 64 00 00       	mov    0x64c4,%eax
    3726:	c7 44 24 04 2e 5b 00 	movl   $0x5b2e,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 41 0a 00 00       	call   4177 <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 3b 5b 00 00 	movl   $0x5b3b,(%esp)
    3745:	e8 f5 08 00 00       	call   403f <unlink>
  pid = fork();
    374a:	e8 98 08 00 00       	call   3fe7 <fork>
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 e0 64 00 00 	movl   $0x5b48,0x64e0(,%eax,4)
    376f:	48 5b 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    3787:	a1 c4 64 00 00       	mov    0x64c4,%eax
    378c:	c7 44 24 04 25 5c 00 	movl   $0x5c25,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 db 09 00 00       	call   4177 <printf>
    exec("echo", args);
    379c:	c7 44 24 04 e0 64 00 	movl   $0x64e0,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 44 45 00 00 	movl   $0x4544,(%esp)
    37ab:	e8 77 08 00 00       	call   4027 <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 c4 64 00 00       	mov    0x64c4,%eax
    37b5:	c7 44 24 04 32 5c 00 	movl   $0x5c32,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 b2 09 00 00       	call   4177 <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 3b 5b 00 00 	movl   $0x5b3b,(%esp)
    37d4:	e8 56 08 00 00       	call   402f <open>
    37d9:	89 45 ec             	mov    %eax,-0x14(%ebp)
    close(fd);
    37dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
    37df:	89 04 24             	mov    %eax,(%esp)
    37e2:	e8 30 08 00 00       	call   4017 <close>
    exit();
    37e7:	e8 03 08 00 00       	call   3fef <exit>
  } else if(pid < 0){
    37ec:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    37f0:	79 1a                	jns    380c <bigargtest+0xd4>
    printf(stdout, "bigargtest: fork failed\n");
    37f2:	a1 c4 64 00 00       	mov    0x64c4,%eax
    37f7:	c7 44 24 04 42 5c 00 	movl   $0x5c42,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 70 09 00 00       	call   4177 <printf>
    exit();
    3807:	e8 e3 07 00 00       	call   3fef <exit>
  }
  wait();
    380c:	e8 e6 07 00 00       	call   3ff7 <wait>
  fd = open("bigarg-ok", 0);
    3811:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    3818:	00 
    3819:	c7 04 24 3b 5b 00 00 	movl   $0x5b3b,(%esp)
    3820:	e8 0a 08 00 00       	call   402f <open>
    3825:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    3828:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    382c:	79 1a                	jns    3848 <bigargtest+0x110>
    printf(stdout, "bigarg test failed!\n");
    382e:	a1 c4 64 00 00       	mov    0x64c4,%eax
    3833:	c7 44 24 04 5b 5c 00 	movl   $0x5c5b,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 34 09 00 00       	call   4177 <printf>
    exit();
    3843:	e8 a7 07 00 00       	call   3fef <exit>
  }
  close(fd);
    3848:	8b 45 ec             	mov    -0x14(%ebp),%eax
    384b:	89 04 24             	mov    %eax,(%esp)
    384e:	e8 c4 07 00 00       	call   4017 <close>
  unlink("bigarg-ok");
    3853:	c7 04 24 3b 5b 00 00 	movl   $0x5b3b,(%esp)
    385a:	e8 e0 07 00 00       	call   403f <unlink>
}
    385f:	c9                   	leave  
    3860:	c3                   	ret    
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 70 5c 00 	movl   $0x5c70,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 f4 08 00 00       	call   4177 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3990:	c7 44 24 04 89 5c 00 	movl   $0x5c89,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 d3 07 00 00       	call   4177 <printf>
      break;
    ...
    39c3:	e8 47 06 00 00       	call   400f <write>
    ...
    39dc:	c7 44 24 04 99 5c 00 	movl   $0x5c99,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 87 07 00 00       	call   4177 <printf>
    close(fd);
    39f0:	8b 45 e8             	mov    -0x18(%ebp),%eax
    39f3:	89 04 24             	mov    %eax,(%esp)
    39f6:	e8 1c 06 00 00       	call   4017 <close>
    if(total == 0)
  ...
  while(nfiles >= 0){
    ...
    3aed:	e8 4d 05 00 00       	call   403f <unlink>
    nfiles--;
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 a9 5c 00 	movl   $0x5ca9,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 63 06 00 00       	call   4177 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3b2a:	c7 44 24 04 bf 5c 00 	movl   $0x5cbf,0x4(%esp)
    3b31:	00 
    3b32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b39:	e8 39 06 00 00       	call   4177 <printf>
  pid = fork();
    3b3e:	e8 a4 04 00 00       	call   3fe7 <fork>
  ...
  if(pid == 0){
    ...
    3b6f:	c7 44 24 04 cc 5c 00 	movl   $0x5ccc,0x4(%esp)
    3b76:	00 
    3b77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b7e:	e8 f4 05 00 00       	call   4177 <printf>
    exit();
    3b83:	e8 67 04 00 00       	call   3fef <exit>
  } else if(pid < 0){
    3b88:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3b8c:	79 19                	jns    3ba7 <uio+0x8d>
    printf (1, "fork failed\n");
    3b8e:	c7 44 24 04 e5 45 00 	movl   $0x45e5,0x4(%esp)
    3b95:	00 
    3b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b9d:	e8 d5 05 00 00       	call   4177 <printf>
    exit();
    3ba2:	e8 48 04 00 00       	call   3fef <exit>
  }
  wait();
    3ba7:	e8 4b 04 00 00       	call   3ff7 <wait>
  printf(1, "uio test done\n");
    3bac:	c7 44 24 04 ed 5c 00 	movl   $0x5ced,0x4(%esp)
    3bb3:	00 
    3bb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3bbb:	e8 b7 05 00 00       	call   4177 <printf>
}
    3bc0:	c9                   	leave  
    3bc1:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3bcf:	00 
    3bd0:	c7 04 24 fc 5c 00 00 	movl   $0x5cfc,(%esp)
    3bd7:	e8 53 04 00 00       	call   402f <open>
    3bdc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if (fd < 0) {
    3bdf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3be3:	79 19                	jns    3bfe <argptest+0x3c>
    printf(2, "open failed\n");
    3be5:	c7 44 24 04 01 5d 00 	movl   $0x5d01,0x4(%esp)
    3bec:	00 
    3bed:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bf4:	e8 7e 05 00 00       	call   4177 <printf>
    exit();
    3bf9:	e8 f1 03 00 00       	call   3fef <exit>
  }
  read(fd, sbrk(0) - 1, -1);
    3bfe:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3c05:	e8 6d 04 00 00       	call   4077 <sbrk>
    ...
    3c1f:	e8 e3 03 00 00       	call   4007 <read>
  close(fd);
    3c24:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3c27:	89 04 24             	mov    %eax,(%esp)
    3c2a:	e8 e8 03 00 00       	call   4017 <close>
  printf(1, "arg test passed\n");
    3c2f:	c7 44 24 04 0e 5d 00 	movl   $0x5d0e,0x4(%esp)
    3c36:	00 
    3c37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c3e:	e8 34 05 00 00       	call   4177 <printf>
}
    3c43:	c9                   	leave  
    3c44:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c48:	a1 c8 64 00 00       	mov    0x64c8,%eax
    3c4d:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3c53:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3c58:	a3 c8 64 00 00       	mov    %eax,0x64c8
  return randstate;
    3c5d:	a1 c8 64 00 00       	mov    0x64c8,%eax
}
    3c62:	5d                   	pop    %ebp
    3c63:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    3c6d:	c7 44 24 04 1f 5d 00 	movl   $0x5d1f,0x4(%esp)
    3c74:	00 
    3c75:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c7c:	e8 f6 04 00 00       	call   4177 <printf>

  if(open("usertests.ran", 0) >= 0){
    3c81:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    3c88:	00 
    3c89:	c7 04 24 33 5d 00 00 	movl   $0x5d33,(%esp)
    3c90:	e8 9a 03 00 00       	call   402f <open>
    3c95:	85 c0                	test   %eax,%eax
    3c97:	78 19                	js     3cb2 <main+0x4e>
    printf(1, "already ran user tests -- rebuild fs.img\n");
    3c99:	c7 44 24 04 44 5d 00 	movl   $0x5d44,0x4(%esp)
    3ca0:	00 
    3ca1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3ca8:	e8 ca 04 00 00       	call   4177 <printf>
    exit();
    3cad:	e8 3d 03 00 00       	call   3fef <exit>
  }
  close(open("usertests.ran", O_CREATE));
    3cb2:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3cb9:	00 
    3cba:	c7 04 24 33 5d 00 00 	movl   $0x5d33,(%esp)
    3cc1:	e8 69 03 00 00       	call   402f <open>
    3cc6:	89 04 24             	mov    %eax,(%esp)
    3cc9:	e8 49 03 00 00       	call   4017 <close>
  ...
  exit();
    3d7d:	e8 6d 02 00 00       	call   3fef <exit>
...
{
    3dac:	55                   	push   %ebp
    3dad:	89 e5                	mov    %esp,%ebp
    3daf:	83 ec 10             	sub    $0x10,%esp
  char *os;

  os = s;
    3db2:	8b 45 08             	mov    0x8(%ebp),%eax
    3db5:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while((*s++ = *t++) != 0)
    3db8:	90                   	nop
    3db9:	8b 45 08             	mov    0x8(%ebp),%eax
    3dbc:	8d 50 01             	lea    0x1(%eax),%edx
    3dbf:	89 55 08             	mov    %edx,0x8(%ebp)
    3dc2:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dc5:	8d 4a 01             	lea    0x1(%edx),%ecx
    3dc8:	89 4d 0c             	mov    %ecx,0xc(%ebp)
    3dcb:	0f b6 12             	movzbl (%edx),%edx
    3dce:	88 10                	mov    %dl,(%eax)
    3dd0:	0f b6 00             	movzbl (%eax),%eax
    3dd3:	84 c0                	test   %al,%al
    3dd5:	75 e2                	jne    3db9 <strcpy+0xd>
    ;
  return os;
    3dd7:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
    3dda:	c9                   	leave  
    3ddb:	c3                   	ret    
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
    3ddf:	eb 08                	jmp    3de9 <strcmp+0xd>
    p++, q++;
    3de1:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    3de5:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
  while(*p && *p == *q)
    3de9:	8b 45 08             	mov    0x8(%ebp),%eax
    3dec:	0f b6 00             	movzbl (%eax),%eax
    3def:	84 c0                	test   %al,%al
    3df1:	74 10                	je     3e03 <strcmp+0x27>
    3df3:	8b 45 08             	mov    0x8(%ebp),%eax
    3df6:	0f b6 10             	movzbl (%eax),%edx
    3df9:	8b 45 0c             	mov    0xc(%ebp),%eax
    3dfc:	0f b6 00             	movzbl (%eax),%eax
    3dff:	38 c2                	cmp    %al,%dl
    3e01:	74 de                	je     3de1 <strcmp+0x5>
  return (uchar)*p - (uchar)*q;
    3e03:	8b 45 08             	mov    0x8(%ebp),%eax
    3e06:	0f b6 00             	movzbl (%eax),%eax
    3e09:	0f b6 d0             	movzbl %al,%edx
    3e0c:	8b 45 0c             	mov    0xc(%ebp),%eax
    3e0f:	0f b6 00             	movzbl (%eax),%eax
    3e12:	0f b6 c0             	movzbl %al,%eax
    3e15:	29 c2                	sub    %eax,%edx
...
{
    3e1b:	55                   	push   %ebp
    3e1c:	89 e5                	mov    %esp,%ebp
    3e1e:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
    3e21:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    3e28:	eb 04                	jmp    3e2e <strlen+0x13>
    3e2a:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
    3e2e:	8b 55 fc             	mov    -0x4(%ebp),%edx
    3e31:	8b 45 08             	mov    0x8(%ebp),%eax
    3e34:	01 d0                	add    %edx,%eax
    3e36:	0f b6 00             	movzbl (%eax),%eax
    3e39:	84 c0                	test   %al,%al
    3e3b:	75 ed                	jne    3e2a <strlen+0xf>
    ;
  return n;
    3e3d:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
    3e40:	c9                   	leave  
    3e41:	c3                   	ret    
...
memset(void *dst, int c, uint n)
{
    ...
    3e45:	83 ec 0c             	sub    $0xc,%esp
  stosb(dst, c, n);
    3e48:	8b 45 10             	mov    0x10(%ebp),%eax
    3e4b:	89 44 24 08          	mov    %eax,0x8(%esp)
    3e4f:	8b 45 0c             	mov    0xc(%ebp),%eax
    3e52:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e56:	8b 45 08             	mov    0x8(%ebp),%eax
    3e59:	89 04 24             	mov    %eax,(%esp)
    3e5c:	e8 21 ff ff ff       	call   3d82 <stosb>
  return dst;
...
strchr(const char *s, char c)
{
    ...
    3e69:	83 ec 04             	sub    $0x4,%esp
    3e6c:	8b 45 0c             	mov    0xc(%ebp),%eax
    3e6f:	88 45 fc             	mov    %al,-0x4(%ebp)
  for(; *s; s++)
    3e72:	eb 14                	jmp    3e88 <strchr+0x22>
    if(*s == c)
    3e74:	8b 45 08             	mov    0x8(%ebp),%eax
    3e77:	0f b6 00             	movzbl (%eax),%eax
    3e7a:	3a 45 fc             	cmp    -0x4(%ebp),%al
    3e7d:	75 05                	jne    3e84 <strchr+0x1e>
      return (char*)s;
    3e7f:	8b 45 08             	mov    0x8(%ebp),%eax
    3e82:	eb 13                	jmp    3e97 <strchr+0x31>
  for(; *s; s++)
    3e84:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    3e88:	8b 45 08             	mov    0x8(%ebp),%eax
    3e8b:	0f b6 00             	movzbl (%eax),%eax
    3e8e:	84 c0                	test   %al,%al
    3e90:	75 e2                	jne    3e74 <strchr+0xe>
  return 0;
    3e92:	b8 00 00 00 00       	mov    $0x0,%eax
}
    3e97:	c9                   	leave  
    3e98:	c3                   	ret    
...
gets(char *buf, int max)
{
    ...
    3e9c:	83 ec 28             	sub    $0x28,%esp
  int i, cc;
  char c;

  for(i=0; i+1 < max; ){
    3e9f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3ea6:	eb 4c                	jmp    3ef4 <gets+0x5b>
    cc = read(0, &c, 1);
    3ea8:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3eaf:	00 
    3eb0:	8d 45 ef             	lea    -0x11(%ebp),%eax
    3eb3:	89 44 24 04          	mov    %eax,0x4(%esp)
    3eb7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3ebe:	e8 44 01 00 00       	call   4007 <read>
    3ec3:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(cc < 1)
    3ec6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3eca:	7f 02                	jg     3ece <gets+0x35>
      break;
    3ecc:	eb 31                	jmp    3eff <gets+0x66>
    buf[i++] = c;
    3ece:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ed1:	8d 50 01             	lea    0x1(%eax),%edx
    3ed4:	89 55 f4             	mov    %edx,-0xc(%ebp)
    3ed7:	89 c2                	mov    %eax,%edx
    3ed9:	8b 45 08             	mov    0x8(%ebp),%eax
    3edc:	01 c2                	add    %eax,%edx
    3ede:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
    3ee2:	88 02                	mov    %al,(%edx)
    if(c == '\n' || c == '\r')
    3ee4:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
    3ee8:	3c 0a                	cmp    $0xa,%al
    3eea:	74 13                	je     3eff <gets+0x66>
    3eec:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
    3ef0:	3c 0d                	cmp    $0xd,%al
    3ef2:	74 0b                	je     3eff <gets+0x66>
  for(i=0; i+1 < max; ){
    3ef4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ef7:	83 c0 01             	add    $0x1,%eax
    3efa:	3b 45 0c             	cmp    0xc(%ebp),%eax
    3efd:	7c a9                	jl     3ea8 <gets+0xf>
      break;
  }
  buf[i] = '\0';
    3eff:	8b 55 f4             	mov    -0xc(%ebp),%edx
    3f02:	8b 45 08             	mov    0x8(%ebp),%eax
    3f05:	01 d0                	add    %edx,%eax
    3f07:	c6 00 00             	movb   $0x0,(%eax)
  return buf;
...
{
    3f0f:	55                   	push   %ebp
    3f10:	89 e5                	mov    %esp,%ebp
    3f12:	83 ec 28             	sub    $0x28,%esp
  int fd;
  int r;

  fd = open(n, O_RDONLY);
    3f15:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    3f1c:	00 
    3f1d:	8b 45 08             	mov    0x8(%ebp),%eax
    3f20:	89 04 24             	mov    %eax,(%esp)
    3f23:	e8 07 01 00 00       	call   402f <open>
    3f28:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0)
    3f2b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3f2f:	79 07                	jns    3f38 <stat+0x29>
    return -1;
    3f31:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    3f36:	eb 23                	jmp    3f5b <stat+0x4c>
  r = fstat(fd, st);
    3f38:	8b 45 0c             	mov    0xc(%ebp),%eax
    3f3b:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3f42:	89 04 24             	mov    %eax,(%esp)
    3f45:	e8 fd 00 00 00       	call   4047 <fstat>
    3f4a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  close(fd);
    3f4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3f50:	89 04 24             	mov    %eax,(%esp)
    3f53:	e8 bf 00 00 00       	call   4017 <close>
  return r;
...
atoi(const char *s)
{
  ...
  n = 0;
    3f63:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
  while('0' <= *s && *s <= '9')
    3f6a:	eb 25                	jmp    3f91 <atoi+0x34>
    n = n*10 + *s++ - '0';
    3f6c:	8b 55 fc             	mov    -0x4(%ebp),%edx
    3f6f:	89 d0                	mov    %edx,%eax
    3f71:	c1 e0 02             	shl    $0x2,%eax
    3f74:	01 d0                	add    %edx,%eax
    3f76:	01 c0                	add    %eax,%eax
    3f78:	89 c1                	mov    %eax,%ecx
    3f7a:	8b 45 08             	mov    0x8(%ebp),%eax
    3f7d:	8d 50 01             	lea    0x1(%eax),%edx
    3f80:	89 55 08             	mov    %edx,0x8(%ebp)
    3f83:	0f b6 00             	movzbl (%eax),%eax
    3f86:	0f be c0             	movsbl %al,%eax
    3f89:	01 c8                	add    %ecx,%eax
    3f8b:	83 e8 30             	sub    $0x30,%eax
    3f8e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while('0' <= *s && *s <= '9')
    3f91:	8b 45 08             	mov    0x8(%ebp),%eax
    3f94:	0f b6 00             	movzbl (%eax),%eax
    3f97:	3c 2f                	cmp    $0x2f,%al
    3f99:	7e 0a                	jle    3fa5 <atoi+0x48>
    3f9b:	8b 45 08             	mov    0x8(%ebp),%eax
    3f9e:	0f b6 00             	movzbl (%eax),%eax
    3fa1:	3c 39                	cmp    $0x39,%al
    3fa3:	7e c7                	jle    3f6c <atoi+0xf>
  return n;
...
memmove(void *vdst, const void *vsrc, int n)
{
    ...
    3fad:	83 ec 10             	sub    $0x10,%esp
  char *dst;
  const char *src;

  dst = vdst;
    3fb0:	8b 45 08             	mov    0x8(%ebp),%eax
    3fb3:	89 45 fc             	mov    %eax,-0x4(%ebp)
  src = vsrc;
    3fb6:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fb9:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0)
    3fbc:	eb 17                	jmp    3fd5 <memmove+0x2b>
    *dst++ = *src++;
    3fbe:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fc1:	8d 50 01             	lea    0x1(%eax),%edx
    3fc4:	89 55 fc             	mov    %edx,-0x4(%ebp)
    3fc7:	8b 55 f8             	mov    -0x8(%ebp),%edx
    3fca:	8d 4a 01             	lea    0x1(%edx),%ecx
    3fcd:	89 4d f8             	mov    %ecx,-0x8(%ebp)
    3fd0:	0f b6 12             	movzbl (%edx),%edx
    3fd3:	88 10                	mov    %dl,(%eax)
  while(n-- > 0)
    3fd5:	8b 45 10             	mov    0x10(%ebp),%eax
    3fd8:	8d 50 ff             	lea    -0x1(%eax),%edx
    3fdb:	89 55 10             	mov    %edx,0x10(%ebp)
    3fde:	85 c0                	test   %eax,%eax
    3fe0:	7f dc                	jg     3fbe <memmove+0x14>
  return vdst;
...
SYSCALL(fork)
    3fe7:	b8 01 00 00 00       	mov    $0x1,%eax
    3fec:	cd 40                	int    $0x40
    3fee:	c3                   	ret    

00003fef <exit>:
SYSCALL(exit)
    3fef:	b8 02 00 00 00       	mov    $0x2,%eax
    3ff4:	cd 40                	int    $0x40
    3ff6:	c3                   	ret    

00003ff7 <wait>:
SYSCALL(wait)
    3ff7:	b8 03 00 00 00       	mov    $0x3,%eax
    3ffc:	cd 40                	int    $0x40
    3ffe:	c3                   	ret    

00003fff <pipe>:
SYSCALL(pipe)
    3fff:	b8 04 00 00 00       	mov    $0x4,%eax
    4004:	cd 40                	int    $0x40
    4006:	c3                   	ret    

00004007 <read>:
SYSCALL(read)
    4007:	b8 05 00 00 00       	mov    $0x5,%eax
    400c:	cd 40                	int    $0x40
    400e:	c3                   	ret    

0000400f <write>:
SYSCALL(write)
    400f:	b8 10 00 00 00       	mov    $0x10,%eax
    4014:	cd 40                	int    $0x40
    4016:	c3                   	ret    

00004017 <close>:
SYSCALL(close)
    4017:	b8 15 00 00 00       	mov    $0x15,%eax
    401c:	cd 40                	int    $0x40
    401e:	c3                   	ret    

0000401f <kill>:
SYSCALL(kill)
    401f:	b8 06 00 00 00       	mov    $0x6,%eax
    4024:	cd 40                	int    $0x40
    4026:	c3                   	ret    

00004027 <exec>:
SYSCALL(exec)
    4027:	b8 07 00 00 00       	mov    $0x7,%eax
    402c:	cd 40                	int    $0x40
    402e:	c3                   	ret    

0000402f <open>:
SYSCALL(open)
    402f:	b8 0f 00 00 00       	mov    $0xf,%eax
    4034:	cd 40                	int    $0x40
    4036:	c3                   	ret    

00004037 <mknod>:
SYSCALL(mknod)
    4037:	b8 11 00 00 00       	mov    $0x11,%eax
    403c:	cd 40                	int    $0x40
    403e:	c3                   	ret    

0000403f <unlink>:
SYSCALL(unlink)
    403f:	b8 12 00 00 00       	mov    $0x12,%eax
    4044:	cd 40                	int    $0x40
    4046:	c3                   	ret    

00004047 <fstat>:
SYSCALL(fstat)
    4047:	b8 08 00 00 00       	mov    $0x8,%eax
    404c:	cd 40                	int    $0x40
    404e:	c3                   	ret    

0000404f <link>:
SYSCALL(link)
    404f:	b8 13 00 00 00       	mov    $0x13,%eax
    4054:	cd 40                	int    $0x40
    4056:	c3                   	ret    

00004057 <mkdir>:
SYSCALL(mkdir)
    4057:	b8 14 00 00 00       	mov    $0x14,%eax
    405c:	cd 40                	int    $0x40
    405e:	c3                   	ret    

0000405f <chdir>:
SYSCALL(chdir)
    405f:	b8 09 00 00 00       	mov    $0x9,%eax
    4064:	cd 40                	int    $0x40
    4066:	c3                   	ret    

00004067 <dup>:
SYSCALL(dup)
    4067:	b8 0a 00 00 00       	mov    $0xa,%eax
    406c:	cd 40                	int    $0x40
    406e:	c3                   	ret    

0000406f <getpid>:
SYSCALL(getpid)
    406f:	b8 0b 00 00 00       	mov    $0xb,%eax
    4074:	cd 40                	int    $0x40
    4076:	c3                   	ret    

00004077 <sbrk>:
SYSCALL(sbrk)
    4077:	b8 0c 00 00 00       	mov    $0xc,%eax
    407c:	cd 40                	int    $0x40
    407e:	c3                   	ret    

0000407f <sleep>:
SYSCALL(sleep)
    407f:	b8 0d 00 00 00       	mov    $0xd,%eax
    4084:	cd 40                	int    $0x40
    4086:	c3                   	ret    

00004087 <uptime>:
SYSCALL(uptime)
    4087:	b8 0e 00 00 00       	mov    $0xe,%eax
    408c:	cd 40                	int    $0x40
    408e:	c3                   	ret    

0000408f <getpinfo>:
SYSCALL(getpinfo)
    408f:	b8 16 00 00 00       	mov    $0x16,%eax
    4094:	cd 40                	int    $0x40
    4096:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    40b8:	e8 52 ff ff ff       	call   400f <write>
}
    40bd:	c9                   	leave  
    40be:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    4110:	0f b6 80 cc 64 00 00 	movzbl 0x64cc(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    426d:	75 09                	jne    4278 <printf+0x101>
          s = "(null)";
    426f:	c7 45 f4 6e 5d 00 00 	movl   $0x5d6e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4339:	a1 68 65 00 00       	mov    0x6568,%eax
  ...
  freep = p;
    ...
    4404:	a3 68 65 00 00       	mov    %eax,0x6568
}
    4409:	c9                   	leave  
    440a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    442a:	e8 48 fc ff ff       	call   4077 <sbrk>
  ...
  return freep;
    445c:	a1 68 65 00 00       	mov    0x6568,%eax
}
    4461:	c9                   	leave  
    4462:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    4478:	a1 68 65 00 00       	mov    0x6568,%eax
    447d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4480:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4484:	75 23                	jne    44a9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4486:	c7 45 f0 60 65 00 00 	movl   $0x6560,-0x10(%ebp)
    448d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4490:	a3 68 65 00 00       	mov    %eax,0x6568
    4495:	a1 68 65 00 00       	mov    0x6568,%eax
    449a:	a3 60 65 00 00       	mov    %eax,0x6560
    base.s.size = 0;
    449f:	c7 05 64 65 00 00 00 	movl   $0x0,0x6564
    44a6:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    44fc:	a3 68 65 00 00       	mov    %eax,0x6568
      return (void*)(p + 1);
    ...
    if(p == freep)
    4509:	a1 68 65 00 00       	mov    0x6568,%eax
