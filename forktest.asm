...
void ps(){
 ...
 15b:	e9 32 01 00 00       	jmp    292 <ps+0x158>
    if (pst[i].inuse == 1){
 160:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 163:	89 d0                	mov    %edx,%eax
 165:	c1 e0 03             	shl    $0x3,%eax
 168:	01 d0                	add    %edx,%eax
 16a:	c1 e0 02             	shl    $0x2,%eax
 16d:	8d 5d e8             	lea    -0x18(%ebp),%ebx
 170:	01 d8                	add    %ebx,%eax
 172:	2d 04 09 00 00       	sub    $0x904,%eax
 177:	8b 00                	mov    (%eax),%eax
 179:	83 f8 01             	cmp    $0x1,%eax
 17c:	0f 85 0c 01 00 00    	jne    28e <ps+0x154>
      printf(1, "PID\tTKTS\tTCKS\tSTAT\tNAME\n");
 182:	c7 44 24 04 fc 05 00 	movl   $0x5fc,0x4(%esp)
 189:	00 
 18a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 191:	e8 6a fe ff ff       	call   0 <printf>
 ...
 296:	0f 8e c4 fe ff ff    	jle    160 <ps+0x26>
    }
  }
}
