...
main(int argc, char *argv[])
{
  ...
  47:	e8 00 03 00 00       	call   34c <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41d:	0f b6 80 e8 0a 00 00 	movzbl 0xae8(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 57a:	75 09                	jne    585 <printf+0x101>
          s = "(null)";
 57c:	c7 45 f4 7d 08 00 00 	movl   $0x87d,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 646:	a1 04 0b 00 00       	mov    0xb04,%eax
 ...
 711:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 716:	c9                   	leave  
 717:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 764:	e8 ce fe ff ff       	call   637 <free>
  return freep;
 769:	a1 04 0b 00 00       	mov    0xb04,%eax
}
 76e:	c9                   	leave  
 76f:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 782:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 785:	a1 04 0b 00 00       	mov    0xb04,%eax
 78a:	89 45 f0             	mov    %eax,-0x10(%ebp)
 78d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 791:	75 23                	jne    7b6 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 793:	c7 45 f0 fc 0a 00 00 	movl   $0xafc,-0x10(%ebp)
 79a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 79d:	a3 04 0b 00 00       	mov    %eax,0xb04
 7a2:	a1 04 0b 00 00       	mov    0xb04,%eax
 7a7:	a3 fc 0a 00 00       	mov    %eax,0xafc
    base.s.size = 0;
 7ac:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 7b3:	00 00 00 
  }
 ...
 809:	a3 04 0b 00 00       	mov    %eax,0xb04
      return (void*)(p + 1);
 ...
 814:	eb 38                	jmp    84e <malloc+0xde>
    ...
    if(p == freep)
 816:	a1 04 0b 00 00       	mov    0xb04,%eax
