...
main(int argc, char *argv[])
{
  ...
  47:	e8 68 04 00 00       	call   4b4 <unlink>
  ...
  66:	c7 44 24 04 d4 09 00 	movl   $0x9d4,0x4(%esp)
  6d:	00 
...
void ps(){
  ...
  d5:	e9 32 01 00 00       	jmp    20c <ps+0x158>
    if (pst[i].inuse == 1){
  da:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  dd:	89 d0                	mov    %edx,%eax
  df:	c1 e0 03             	shl    $0x3,%eax
  e2:	01 d0                	add    %edx,%eax
  e4:	c1 e0 02             	shl    $0x2,%eax
  e7:	8d 5d e8             	lea    -0x18(%ebp),%ebx
  ea:	01 d8                	add    %ebx,%eax
  ec:	2d 04 09 00 00       	sub    $0x904,%eax
  f1:	8b 00                	mov    (%eax),%eax
  f3:	83 f8 01             	cmp    $0x1,%eax
  f6:	0f 85 0c 01 00 00    	jne    208 <ps+0x154>
      printf(1, "PID\tTKTS\tTCKS\tSTAT\tNAME\n");
  fc:	c7 44 24 04 ed 09 00 	movl   $0x9ed,0x4(%esp)
 103:	00 
 104:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 10b:	e8 e4 04 00 00       	call   5f4 <printf>
 ...
 12d:	c7 44 24 04 06 0a 00 	movl   $0xa06,0x4(%esp)
 134:	00 
 ...
 15e:	c7 44 24 04 06 0a 00 	movl   $0xa06,0x4(%esp)
 165:	00 
 ...
 18f:	c7 44 24 04 06 0a 00 	movl   $0xa06,0x4(%esp)
 196:	00 
 ...
 1c4:	c7 44 24 04 0a 0a 00 	movl   $0xa0a,0x4(%esp)
 1cb:	00 
 ...
 1f4:	c7 44 24 04 0e 0a 00 	movl   $0xa0e,0x4(%esp)
 1fb:	00 
 ...
 210:	0f 8e c4 fe ff ff    	jle    da <ps+0x26>
    }
  }
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 58d:	0f b6 80 90 0c 00 00 	movzbl 0xc90(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 6ea:	75 09                	jne    6f5 <printf+0x101>
          s = "(null)";
 6ec:	c7 45 f4 13 0a 00 00 	movl   $0xa13,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b6:	a1 ac 0c 00 00       	mov    0xcac,%eax
 ...
 881:	a3 ac 0c 00 00       	mov    %eax,0xcac
}
 886:	c9                   	leave  
 887:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8d4:	e8 ce fe ff ff       	call   7a7 <free>
  return freep;
 8d9:	a1 ac 0c 00 00       	mov    0xcac,%eax
}
 8de:	c9                   	leave  
 8df:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8f2:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8f5:	a1 ac 0c 00 00       	mov    0xcac,%eax
 8fa:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8fd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 901:	75 23                	jne    926 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 903:	c7 45 f0 a4 0c 00 00 	movl   $0xca4,-0x10(%ebp)
 90a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 90d:	a3 ac 0c 00 00       	mov    %eax,0xcac
 912:	a1 ac 0c 00 00       	mov    0xcac,%eax
 917:	a3 a4 0c 00 00       	mov    %eax,0xca4
    base.s.size = 0;
 91c:	c7 05 a8 0c 00 00 00 	movl   $0x0,0xca8
 923:	00 00 00 
  }
 ...
 979:	a3 ac 0c 00 00       	mov    %eax,0xcac
      return (void*)(p + 1);
 ...
 984:	eb 38                	jmp    9be <malloc+0xde>
    ...
    if(p == freep)
 986:	a1 ac 0c 00 00       	mov    0xcac,%eax
